...
inline void to_yaml(
  const std_srvs::srv::GetUint8WithTitle_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const std_srvs::srv::GetUint8WithTitle_Request & msg)
{
...
[[deprecated("use std_srvs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const std_srvs::srv::GetUint8WithTitle_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  std_srvs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use std_srvs::srv::to_yaml() instead")]]
inline std::string to_yaml(const std_srvs::srv::GetUint8WithTitle_Response & msg)
{
  return std_srvs::srv::to_yaml(msg);
}
...
[[deprecated("use std_srvs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const std_srvs::srv::GetUint8WithTitle_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  std_srvs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use std_srvs::srv::to_yaml() instead")]]
inline std::string to_yaml(const std_srvs::srv::GetUint8WithTitle_Event & msg)
{
  return std_srvs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<std_srvs::srv::GetUint8WithTitle_Event>()
{
  return "std_srvs::srv::GetUint8WithTitle_Event";
}

template<>
inline const char * name<std_srvs::srv::GetUint8WithTitle_Event>()
{
  return "std_srvs/srv/GetUint8WithTitle_Event";
}
