...
enum
{
  std_srvs__srv__SetUint8ArrayWithTitle_Event__request__MAX_SIZE = 1
};
// response
enum
{
  std_srvs__srv__SetUint8ArrayWithTitle_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetUint8ArrayWithTitle in the package std_srvs.
typedef struct std_srvs__srv__SetUint8ArrayWithTitle_Event
{
  service_msgs__msg__ServiceEventInfo info;
  std_srvs__srv__SetUint8ArrayWithTitle_Request__Sequence request;
  std_srvs__srv__SetUint8ArrayWithTitle_Response__Sequence response;
} std_srvs__srv__SetUint8ArrayWithTitle_Event;

// Struct for a sequence of std_srvs__srv__SetUint8ArrayWithTitle_Event.
typedef struct std_srvs__srv__SetUint8ArrayWithTitle_Event__Sequence
{
