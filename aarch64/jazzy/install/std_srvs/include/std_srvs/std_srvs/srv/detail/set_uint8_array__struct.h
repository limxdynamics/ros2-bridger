...
enum
{
  std_srvs__srv__SetUint8Array_Event__request__MAX_SIZE = 1
};
// response
enum
{
  std_srvs__srv__SetUint8Array_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetUint8Array in the package std_srvs.
typedef struct std_srvs__srv__SetUint8Array_Event
{
  service_msgs__msg__ServiceEventInfo info;
  std_srvs__srv__SetUint8Array_Request__Sequence request;
  std_srvs__srv__SetUint8Array_Response__Sequence response;
} std_srvs__srv__SetUint8Array_Event;

// Struct for a sequence of std_srvs__srv__SetUint8Array_Event.
typedef struct std_srvs__srv__SetUint8Array_Event__Sequence
{
