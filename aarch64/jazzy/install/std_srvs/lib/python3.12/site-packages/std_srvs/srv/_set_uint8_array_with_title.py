...
class Metaclass_SetUint8ArrayWithTitle_Event(type):
...
class SetUint8ArrayWithTitle_Event(metaclass=Metaclass_SetUint8ArrayWithTitle_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetUint8ArrayWithTitle_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetUint8ArrayWithTitle_Response'"
...
class SetUint8ArrayWithTitle(metaclass=Metaclass_SetUint8ArrayWithTitle):
    ...
    from std_srvs.srv._set_uint8_array_with_title import SetUint8ArrayWithTitle_Event as Event
