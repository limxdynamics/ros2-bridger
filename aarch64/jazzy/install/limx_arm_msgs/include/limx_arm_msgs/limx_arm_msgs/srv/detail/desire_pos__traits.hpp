...
inline void to_yaml(
  const limx_arm_msgs::srv::desire_pos_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const limx_arm_msgs::srv::desire_pos_Request & msg)
{
...
[[deprecated("use limx_arm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const limx_arm_msgs::srv::desire_pos_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  limx_arm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use limx_arm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const limx_arm_msgs::srv::desire_pos_Response & msg)
{
  return limx_arm_msgs::srv::to_yaml(msg);
}
...
[[deprecated("use limx_arm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const limx_arm_msgs::srv::desire_pos_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  limx_arm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use limx_arm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const limx_arm_msgs::srv::desire_pos_Event & msg)
{
  return limx_arm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<limx_arm_msgs::srv::desire_pos_Event>()
{
  return "limx_arm_msgs::srv::desire_pos_Event";
}

template<>
inline const char * name<limx_arm_msgs::srv::desire_pos_Event>()
{
  return "limx_arm_msgs/srv/desire_pos_Event";
}
