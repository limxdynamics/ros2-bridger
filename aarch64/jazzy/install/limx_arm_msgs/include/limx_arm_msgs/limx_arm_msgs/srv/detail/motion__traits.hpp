...
inline void to_yaml(
  const limx_arm_msgs::srv::motion_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const limx_arm_msgs::srv::motion_Request & msg)
{
  return limx_arm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<limx_arm_msgs::srv::motion_Request>()
{
  return "limx_arm_msgs::srv::motion_Request";
}

template<>
inline const char * name<limx_arm_msgs::srv::motion_Request>()
{
  return "limx_arm_msgs/srv/motion_Request";
}
...
[[deprecated("use limx_arm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const limx_arm_msgs::srv::motion_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  limx_arm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use limx_arm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const limx_arm_msgs::srv::motion_Response & msg)
{
  return limx_arm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<limx_arm_msgs::srv::motion_Response>()
{
  return "limx_arm_msgs::srv::motion_Response";
}

template<>
inline const char * name<limx_arm_msgs::srv::motion_Response>()
{
  return "limx_arm_msgs/srv/motion_Response";
}
...
[[deprecated("use limx_arm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const limx_arm_msgs::srv::motion_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  limx_arm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use limx_arm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const limx_arm_msgs::srv::motion_Event & msg)
{
  return limx_arm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<limx_arm_msgs::srv::motion_Event>()
{
  return "limx_arm_msgs::srv::motion_Event";
}

template<>
inline const char * name<limx_arm_msgs::srv::motion_Event>()
{
  return "limx_arm_msgs/srv/motion_Event";
}
...
template<>
inline const char * data_type<limx_arm_msgs::srv::motion>()
{
  return "limx_arm_msgs::srv::motion";
}

template<>
inline const char * name<limx_arm_msgs::srv::motion>()
{
  return "limx_arm_msgs/srv/motion";
}
