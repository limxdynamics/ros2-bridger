...
class Init_motion_Event_response
{
public:
  explicit Init_motion_Event_response(::limx_arm_msgs::srv::motion_Event & msg)
  : msg_(msg)
  {}
  ::limx_arm_msgs::srv::motion_Event response(::limx_arm_msgs::srv::motion_Event::_response_type arg)
  {
...
private:
  ::limx_arm_msgs::srv::motion_Event msg_;
};

class Init_motion_Event_request
{
public:
  explicit Init_motion_Event_request(::limx_arm_msgs::srv::motion_Event & msg)
  : msg_(msg)
  {}
  Init_motion_Event_response request(::limx_arm_msgs::srv::motion_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_motion_Event_response(msg_);
  }
...
class Init_motion_Event_info
{
public:
  Init_motion_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_motion_Event_request info(::limx_arm_msgs::srv::motion_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_motion_Event_request(msg_);
  }
...
template<>
inline
auto build<::limx_arm_msgs::srv::motion_Event>()
{
  return limx_arm_msgs::srv::builder::Init_motion_Event_info();
}
