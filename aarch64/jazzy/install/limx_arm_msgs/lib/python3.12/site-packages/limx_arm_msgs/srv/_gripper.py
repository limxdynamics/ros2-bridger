...
class Metaclass_gripper_Event(type):
    """Metaclass of message 'gripper_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__gripper__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__gripper__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__gripper__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__gripper__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__gripper__event
...
class gripper_Event(metaclass=Metaclass_gripper_Event):
    """Message class 'gripper_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<limx_arm_msgs/gripper_Request, 1>',
        'response': 'sequence<limx_arm_msgs/gripper_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['limx_arm_msgs', 'srv'], 'gripper_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['limx_arm_msgs', 'srv'], 'gripper_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from limx_arm_msgs.srv import gripper_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, gripper_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'gripper_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from limx_arm_msgs.srv import gripper_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, gripper_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'gripper_Response'"
...
class Metaclass_gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _gripper.Metaclass_gripper_Event._TYPE_SUPPORT is None:
                _gripper.Metaclass_gripper_Event.__import_type_support__()
...
class gripper(metaclass=Metaclass_gripper):
    ...
    from limx_arm_msgs.srv._gripper import gripper_Event as Event
