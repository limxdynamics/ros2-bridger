...
#ifndef TRON2_MANIPULATION__SRV__DETAIL__ARM_MOVE__FUNCTIONS_H_
#define TRON2_MANIPULATION__SRV__DETAIL__ARM_MOVE__FUNCTIONS_H_
 ...
 * calls
 * tron2_manipulation__srv__arm_move_Request__init().
...
/**
 * It calls
 * tron2_manipulation__srv__arm_move_Request__fini()
 ...
 * tron2_manipulation__srv__arm_move_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tron2_manipulation__srv__arm_move_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tron2_manipulation__srv__arm_move_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
...
/**
 * It calls
 * tron2_manipulation__srv__arm_move_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
...
/**
 * It allocates the memory for the array and calls
 * tron2_manipulation__srv__arm_move_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
...
/**
 * It calls
 * tron2_manipulation__srv__arm_move_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * tron2_manipulation__srv__arm_move_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tron2_manipulation__srv__arm_move_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
...
/**
 * It calls
 * tron2_manipulation__srv__arm_move_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
...
/**
 * It allocates the memory for the array and calls
 * tron2_manipulation__srv__arm_move_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tron2_manipulation
...
/**
 * It calls
 * tron2_manipulation__srv__arm_move_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRON2_MANIPULATION__SRV__DETAIL__ARM_MOVE__FUNCTIONS_H_
