...
[[deprecated("use upper_body::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const upper_body::srv::arm_move_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  upper_body::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use upper_body::srv::to_yaml() instead")]]
inline std::string to_yaml(const upper_body::srv::arm_move_Event & msg)
{
  return upper_body::srv::to_yaml(msg);
}

template<>
inline const char * data_type<upper_body::srv::arm_move_Event>()
{
  return "upper_body::srv::arm_move_Event";
}

template<>
inline const char * name<upper_body::srv::arm_move_Event>()
{
  return "upper_body/srv/arm_move_Event";
}
