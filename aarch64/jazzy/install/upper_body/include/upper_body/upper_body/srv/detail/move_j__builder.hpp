...
{
public:
  explicit Init_moveJ_Event_response(::upper_body::srv::moveJ_Event & msg)
  : msg_(msg)
  {}
  ::upper_body::srv::moveJ_Event response(::upper_body::srv::moveJ_Event::_response_type arg)
  {
...
private:
  ::upper_body::srv::moveJ_Event msg_;
};

class Init_moveJ_Event_request
{
public:
  explicit Init_moveJ_Event_request(::upper_body::srv::moveJ_Event & msg)
  : msg_(msg)
  {}
  Init_moveJ_Event_response request(::upper_body::srv::moveJ_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_moveJ_Event_request info(::upper_body::srv::moveJ_Event::_info_type arg)
  {
...
template<>
inline
auto build<::upper_body::srv::moveJ_Event>()
{
  return upper_body::srv::builder::Init_moveJ_Event_info();
}
