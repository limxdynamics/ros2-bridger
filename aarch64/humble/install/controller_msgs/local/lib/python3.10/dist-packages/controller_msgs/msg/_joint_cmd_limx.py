...
class Metaclass_JointCmdLimx(type):
    """Metaclass of message 'JointCmdLimx'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'controller_msgs.msg.JointCmdLimx')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_cmd_limx
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_cmd_limx
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_cmd_limx
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_cmd_limx
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_cmd_limx
...
class JointCmdLimx(metaclass=Metaclass_JointCmdLimx):
    """Message class 'JointCmdLimx'."""
    ...
    _fields_and_field_types = {
        ...
        'mode': 'sequence<uint8>',
        'na': 'uint32',
        'parallel_solver_mode': 'sequence<uint8>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.parallel_solver_mode = array.array('B', kwargs.get('parallel_solver_mode', []))
    ...
    def __eq__(self, other):
        ...
        if self.na != other.na:
            return False
        if self.parallel_solver_mode != other.parallel_solver_mode:
            return False
        return True
    ...
    @builtins.property
    def parallel_solver_mode(self):
        """Message field 'parallel_solver_mode'."""
        return self._parallel_solver_mode

    @parallel_solver_mode.setter
    def parallel_solver_mode(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'parallel_solver_mode' array.array() must have the type code of 'B'"
            self._parallel_solver_mode = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 256 for val in value)), \
                "The 'parallel_solver_mode' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._parallel_solver_mode = array.array('B', value)
