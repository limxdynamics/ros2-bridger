...
bool limx_arm_msgs__msg__servo_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("limx_arm_msgs.msg._servo_cmd.ServoCmd", full_classname_dest, 37) == 0);
  }
  limx_arm_msgs__msg__ServoCmd * ros_message = _ros_message;
  {  // functionName
...
{
  /* NOTE(esteve): Call constructor of ServoCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("limx_arm_msgs.msg._servo_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoCmd");
