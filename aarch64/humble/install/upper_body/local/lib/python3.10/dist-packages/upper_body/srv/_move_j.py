...
class Metaclass_moveJ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from upper_body.srv import _move_j
...
class moveJ(metaclass=Metaclass_moveJ):
    from upper_body.srv._move_j import moveJ_Request as Request
    from upper_body.srv._move_j import moveJ_Response as Response
