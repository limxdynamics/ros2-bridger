...
class Metaclass_GetBool(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from std_srvs.srv import _get_bool
...
class GetBool(metaclass=Metaclass_GetBool):
    from std_srvs.srv._get_bool import GetBool_Request as Request
    from std_srvs.srv._get_bool import GetBool_Response as Response
