...
bool std_msgs__msg__time__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._time.Time", full_classname_dest, 23) == 0);
  }
  std_msgs__msg__Time * ros_message = _ros_message;
  {  // data
...
PyObject * std_msgs__msg__time__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._time");
