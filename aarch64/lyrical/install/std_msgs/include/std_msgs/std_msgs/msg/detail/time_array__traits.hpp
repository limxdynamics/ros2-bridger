...
// Member 'data'
#include "std_msgs/msg/detail/time__traits.hpp"
...
inline std::string to_yaml(const TimeArray & msg, bool use_flow_style = false)
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_msgs::msg::TimeArray>, int> = 0>
...
template<>
constexpr const char * data_type<std_msgs::msg::TimeArray>()
{
  return "std_msgs::msg::TimeArray";
}

template<>
constexpr const char * name<std_msgs::msg::TimeArray>()
{
  return "std_msgs/msg/TimeArray";
}
...
template<>
struct MessageTraits<std_msgs::msg::TimeArray>
{
