...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_msgs::msg::MultiArrayDimension>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).label,
    std::forward<T>(msg).size,
    std::forward<T>(msg).stride);
}
...
template<>
constexpr const char * data_type<std_msgs::msg::MultiArrayDimension>()
{
  return "std_msgs::msg::MultiArrayDimension";
}

template<>
constexpr const char * name<std_msgs::msg::MultiArrayDimension>()
{
  return "std_msgs/msg/MultiArrayDimension";
}
...
template<>
struct MessageTraits<std_msgs::msg::MultiArrayDimension>
{
