...
{
  new (message_memory) std_msgs::msg::Float32Array(_init);
}

void Float32Array_fini_function(void * message_memory)
{
  auto typed_message = static_cast<std_msgs::msg::Float32Array *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float32Array_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(std_msgs::msg::Float32Array, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(std_msgs::msg::Float32Array, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float32Array_message_members = {
  ...
  2,  // number of fields
  sizeof(std_msgs::msg::Float32Array),
...
get_message_type_support_handle<std_msgs::msg::Float32Array>()
{
  return &::std_msgs::msg::rosidl_typesupport_introspection_cpp::Float32Array_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, std_msgs, msg, Float32Array)() {
  return &::std_msgs::msg::rosidl_typesupport_introspection_cpp::Float32Array_message_type_support_handle;
}
