...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_msgs::msg::Float32>, int> = 0>
...
template<>
constexpr const char * data_type<std_msgs::msg::Float32>()
{
  return "std_msgs::msg::Float32";
}

template<>
constexpr const char * name<std_msgs::msg::Float32>()
{
  return "std_msgs/msg/Float32";
}
...
template<>
struct MessageTraits<std_msgs::msg::Float32>
{
