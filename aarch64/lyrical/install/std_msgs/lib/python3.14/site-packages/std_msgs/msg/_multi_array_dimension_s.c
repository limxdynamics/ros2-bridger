...
bool std_msgs__msg__multi_array_dimension__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._multi_array_dimension", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("MultiArrayDimension", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
