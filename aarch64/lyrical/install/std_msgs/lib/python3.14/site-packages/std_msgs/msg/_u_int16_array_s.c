...
bool std_msgs__msg__u_int16_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._u_int16_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("UInt16Array", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  std_msgs__msg__UInt16Array * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of UInt16Array */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._u_int16_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UInt16Array");
