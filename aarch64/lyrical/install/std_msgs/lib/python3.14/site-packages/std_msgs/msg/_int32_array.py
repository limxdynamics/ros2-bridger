...
class Metaclass_Int32Array(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    """Metaclass of message 'Int32Array'."""
    ...
    class Int32ArrayConstants(typing.TypedDict):
        pass

    __constants: Int32ArrayConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            logger = logging.getLogger(
                'std_msgs.msg.Int32Array')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__int32_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__int32_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__int32_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__int32_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__int32_array
...
class Int32Array(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Int32Array):
    """Message class 'Int32Array'."""
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, Int32Array):
            return False
