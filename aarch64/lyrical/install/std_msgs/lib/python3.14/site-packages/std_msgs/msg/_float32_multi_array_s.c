...
bool std_msgs__msg__float32_multi_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._float32_multi_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("Float32MultiArray", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
