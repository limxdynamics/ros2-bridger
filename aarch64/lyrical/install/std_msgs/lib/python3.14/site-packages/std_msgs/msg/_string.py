# noqa: A005
# Module _string.py shadows a builtin
...
class Metaclass_String(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class StringConstants(typing.TypedDict):
        pass

    __constants: StringConstants = {
    }
...
class String(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_String):
