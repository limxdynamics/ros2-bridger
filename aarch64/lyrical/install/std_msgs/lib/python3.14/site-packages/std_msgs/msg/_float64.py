...
class Metaclass_Float64(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class Float64Constants(typing.TypedDict):
        pass

    __constants: Float64Constants = {
    }
...
class Float64(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Float64):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, Float64):
            return False
