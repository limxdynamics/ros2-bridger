...
bool teleop_msgs__msg__teleop_session_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_msgs.msg._teleop_session_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("TeleopSessionState", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
