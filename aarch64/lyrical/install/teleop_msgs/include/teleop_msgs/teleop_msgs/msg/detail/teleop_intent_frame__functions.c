...
teleop_msgs__msg__TeleopIntentFrame__Sequence__init(teleop_msgs__msg__TeleopIntentFrame__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(teleop_msgs__msg__TeleopIntentFrame)) {
      return false;
    }
  ...
  teleop_msgs__msg__TeleopIntentFrame__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(teleop_msgs__msg__TeleopIntentFrame)) {
      return false;
    }
    ...
    teleop_msgs__msg__TeleopIntentFrame * data =
      (teleop_msgs__msg__TeleopIntentFrame *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!teleop_msgs__msg__TeleopIntentFrame__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          teleop_msgs__msg__TeleopIntentFrame__fini(&output->data[i]);
        }
        return false;
      }
    }
