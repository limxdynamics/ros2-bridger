...
class Metaclass_HandState(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class HandStateConstants(typing.TypedDict):
        pass

    __constants: HandStateConstants = {
    }
...
class HandState(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_HandState):
