...
#ifndef HAND_MSGS__MSG__DETAIL__HAND_STATE__TRAITS_HPP_
#define HAND_MSGS__MSG__DETAIL__HAND_STATE__TRAITS_HPP_
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, hand_msgs::msg::HandState>, int> = 0>
...
template<>
constexpr const char * data_type<hand_msgs::msg::HandState>()
{
  return "hand_msgs::msg::HandState";
}

template<>
constexpr const char * name<hand_msgs::msg::HandState>()
{
  return "hand_msgs/msg/HandState";
}

template<>
struct has_fixed_size<hand_msgs::msg::HandState>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<hand_msgs::msg::HandState>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<hand_msgs::msg::HandState>
  : std::true_type {};

template<>
struct MessageTraits<hand_msgs::msg::HandState>
{
...
#endif  // HAND_MSGS__MSG__DETAIL__HAND_STATE__TRAITS_HPP_
