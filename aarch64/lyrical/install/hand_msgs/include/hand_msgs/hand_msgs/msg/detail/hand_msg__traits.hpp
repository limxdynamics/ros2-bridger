...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, hand_msgs::msg::HandMsg>, int> = 0>
...
template<>
constexpr const char * data_type<hand_msgs::msg::HandMsg>()
{
  return "hand_msgs::msg::HandMsg";
}

template<>
constexpr const char * name<hand_msgs::msg::HandMsg>()
{
  return "hand_msgs/msg/HandMsg";
}
...
template<>
struct MessageTraits<hand_msgs::msg::HandMsg>
{
