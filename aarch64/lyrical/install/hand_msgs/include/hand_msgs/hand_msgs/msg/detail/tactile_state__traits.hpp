...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, hand_msgs::msg::TactileState>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).header,
    std::forward<T>(msg).names,
    std::forward<T>(msg).normal_force,
    std::forward<T>(msg).tangential_force,
    std::forward<T>(msg).direction_angle,
    std::forward<T>(msg).approximate_value,
    std::forward<T>(msg).tactile_state);
}
...
template<>
constexpr const char * data_type<hand_msgs::msg::TactileState>()
{
  return "hand_msgs::msg::TactileState";
}

template<>
constexpr const char * name<hand_msgs::msg::TactileState>()
{
  return "hand_msgs/msg/TactileState";
}
...
template<>
struct MessageTraits<hand_msgs::msg::TactileState>
{
