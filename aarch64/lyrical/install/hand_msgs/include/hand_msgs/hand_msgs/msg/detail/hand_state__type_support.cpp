...
void fetch_function__HandState__ctrl_mode(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__HandState__ctrl_mode(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__HandState__ctrl_mode(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__HandState__ctrl_mode(untyped_member, index));
...
void fetch_function__HandState__hand_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const hand_msgs::msg::HandMsg *>(
    get_const_function__HandState__hand_state(untyped_member, index));
  auto & value = *reinterpret_cast<hand_msgs::msg::HandMsg *>(untyped_value);
  value = item;
}

void assign_function__HandState__hand_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<hand_msgs::msg::HandMsg *>(
    get_function__HandState__hand_state(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HandState_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__HandState__ctrl_mode,  // fetch(index, &value) function pointer
    assign_function__HandState__ctrl_mode,  // assign(index, value) function pointer
    nullptr,  // resize(index) function pointer
    false  // is_rosidl_buffer
  },
  {
    ...
    fetch_function__HandState__hand_state,  // fetch(index, &value) function pointer
    assign_function__HandState__hand_state,  // assign(index, value) function pointer
    nullptr,  // resize(index) function pointer
    false  // is_rosidl_buffer
  }
};
