...
inline std::string to_yaml(const arm_pose & msg, bool use_flow_style = false)
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, tron2_manipulation::msg::arm_pose>, int> = 0>
...
template<>
constexpr const char * data_type<tron2_manipulation::msg::arm_pose>()
{
  return "tron2_manipulation::msg::arm_pose";
}

template<>
constexpr const char * name<tron2_manipulation::msg::arm_pose>()
{
  return "tron2_manipulation/msg/arm_pose";
}
...
template<>
struct MessageTraits<tron2_manipulation::msg::arm_pose>
{
