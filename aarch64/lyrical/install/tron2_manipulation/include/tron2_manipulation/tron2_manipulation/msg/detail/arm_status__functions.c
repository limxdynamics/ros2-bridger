...
tron2_manipulation__msg__arm_status__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tron2_manipulation__msg__arm_status * msg = (tron2_manipulation__msg__arm_status *)allocator.allocate(sizeof(tron2_manipulation__msg__arm_status), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tron2_manipulation__msg__arm_status));
  bool success = tron2_manipulation__msg__arm_status__init(msg);
  if (!success) {
...
tron2_manipulation__msg__arm_status__destroy(tron2_manipulation__msg__arm_status * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tron2_manipulation__msg__arm_status__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tron2_manipulation__msg__arm_status__Sequence__init(tron2_manipulation__msg__arm_status__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tron2_manipulation__msg__arm_status * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(tron2_manipulation__msg__arm_status)) {
      return false;
    }
    data = (tron2_manipulation__msg__arm_status *)allocator.zero_allocate(size, sizeof(tron2_manipulation__msg__arm_status), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tron2_manipulation__msg__arm_status__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tron2_manipulation__msg__arm_status__fini(&data[i - 1]);
      }
...
tron2_manipulation__msg__arm_status__Sequence__fini(tron2_manipulation__msg__arm_status__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tron2_manipulation__msg__arm_status__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tron2_manipulation__msg__arm_status__Sequence * array = (tron2_manipulation__msg__arm_status__Sequence *)allocator.allocate(sizeof(tron2_manipulation__msg__arm_status__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tron2_manipulation__msg__arm_status__Sequence__init(array, size);
  if (!success) {
...
tron2_manipulation__msg__arm_status__Sequence__destroy(tron2_manipulation__msg__arm_status__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tron2_manipulation__msg__arm_status__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tron2_manipulation__msg__arm_status__Sequence__are_equal(const tron2_manipulation__msg__arm_status__Sequence * lhs, const tron2_manipulation__msg__arm_status__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tron2_manipulation__msg__arm_status__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tron2_manipulation__msg__arm_status__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(tron2_manipulation__msg__arm_status)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(tron2_manipulation__msg__arm_status);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tron2_manipulation__msg__arm_status * data =
      (tron2_manipulation__msg__arm_status *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tron2_manipulation__msg__arm_status__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tron2_manipulation__msg__arm_status__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tron2_manipulation__msg__arm_status__copy(
