...
// IWYU pragma: private, include "tron2_manipulation/srv/arm_move.hpp"
...
#ifndef _WIN32
# define DEPRECATED__tron2_manipulation__srv__arm_move_Event __attribute__((deprecated))
#else
# define DEPRECATED__tron2_manipulation__srv__arm_move_Event __declspec(deprecated)
#endif
...
struct arm_move_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<tron2_manipulation::srv::arm_move_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tron2_manipulation::srv::arm_move_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<tron2_manipulation::srv::arm_move_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tron2_manipulation::srv::arm_move_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<tron2_manipulation::srv::arm_move_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tron2_manipulation::srv::arm_move_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<tron2_manipulation::srv::arm_move_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tron2_manipulation::srv::arm_move_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    tron2_manipulation::srv::arm_move_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const tron2_manipulation::srv::arm_move_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tron2_manipulation::srv::arm_move_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      tron2_manipulation::srv::arm_move_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tron2_manipulation__srv__arm_move_Event
    std::shared_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tron2_manipulation__srv__arm_move_Event
    std::shared_ptr<tron2_manipulation::srv::arm_move_Event_<ContainerAllocator> const>
...
using arm_move_Event =
  tron2_manipulation::srv::arm_move_Event_<std::allocator<void>>;
...
struct arm_move
{
  ...
  using Event = tron2_manipulation::srv::arm_move_Event;
};
