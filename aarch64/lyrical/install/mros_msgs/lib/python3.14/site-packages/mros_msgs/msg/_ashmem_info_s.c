...
bool mros_msgs__msg__ashmem_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mros_msgs.msg._ashmem_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("AshmemInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
