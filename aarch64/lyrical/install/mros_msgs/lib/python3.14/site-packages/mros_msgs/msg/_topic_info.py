...
class Metaclass_TopicInfo(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class TopicInfoConstants(typing.TypedDict):
        ID_PUBLISHER: typing.Literal[0]
        ID_SUBSCRIBER: typing.Literal[1]
        ID_SERVICE_SERVER: typing.Literal[2]
        ID_SERVICE_CLIENT: typing.Literal[4]
        ID_MROSTOPIC_REQUEST: typing.Literal[6]
        ID_REMOVE_PUBLISHER: typing.Literal[7]
        ID_REMOVE_SUBSCRIBER: typing.Literal[8]
        ID_REMOVE_SERVICE_SERVER: typing.Literal[9]
        ID_REMOVE_SERVICE_CLIENT: typing.Literal[11]
        ID_MROSSERVICE_REQUEST: typing.Literal[13]
        ID_LOG: typing.Literal[14]
        ID_TIME: typing.Literal[15]
        ID_NEGOTIATED: typing.Literal[16]
        ID_SESSION_ID: typing.Literal[17]
        ID_ASHMEM_INFO: typing.Literal[18]
        ID_DIAG: typing.Literal[19]

    __constants: TopicInfoConstants = {
        'ID_PUBLISHER': 0,
        'ID_SUBSCRIBER': 1,
        'ID_SERVICE_SERVER': 2,
        'ID_SERVICE_CLIENT': 4,
    ...
    def __prepare__(metacls, name: str, bases: tuple[type[typing.Any], ...], /, **kwds: typing.Any) -> collections.abc.MutableMapping[str, object]:
        ...
        return {
            'ID_PUBLISHER': metacls.__constants['ID_PUBLISHER'],
            'ID_SUBSCRIBER': metacls.__constants['ID_SUBSCRIBER'],
            'ID_SERVICE_SERVER': metacls.__constants['ID_SERVICE_SERVER'],
            'ID_SERVICE_CLIENT': metacls.__constants['ID_SERVICE_CLIENT'],
            'ID_MROSTOPIC_REQUEST': metacls.__constants['ID_MROSTOPIC_REQUEST'],
            'ID_REMOVE_PUBLISHER': metacls.__constants['ID_REMOVE_PUBLISHER'],
            'ID_REMOVE_SUBSCRIBER': metacls.__constants['ID_REMOVE_SUBSCRIBER'],
            'ID_REMOVE_SERVICE_SERVER': metacls.__constants['ID_REMOVE_SERVICE_SERVER'],
            'ID_REMOVE_SERVICE_CLIENT': metacls.__constants['ID_REMOVE_SERVICE_CLIENT'],
            'ID_MROSSERVICE_REQUEST': metacls.__constants['ID_MROSSERVICE_REQUEST'],
            'ID_LOG': metacls.__constants['ID_LOG'],
            'ID_TIME': metacls.__constants['ID_TIME'],
            'ID_NEGOTIATED': metacls.__constants['ID_NEGOTIATED'],
            'ID_SESSION_ID': metacls.__constants['ID_SESSION_ID'],
            'ID_ASHMEM_INFO': metacls.__constants['ID_ASHMEM_INFO'],
            'ID_DIAG': metacls.__constants['ID_DIAG'],
        }

    @property
    def ID_PUBLISHER(self) -> typing.Literal[0]:
        """Message constant 'ID_PUBLISHER'."""
        return Metaclass_TopicInfo.__constants['ID_PUBLISHER']

    @property
    def ID_SUBSCRIBER(self) -> typing.Literal[1]:
        """Message constant 'ID_SUBSCRIBER'."""
        return Metaclass_TopicInfo.__constants['ID_SUBSCRIBER']

    @property
    def ID_SERVICE_SERVER(self) -> typing.Literal[2]:
        """Message constant 'ID_SERVICE_SERVER'."""
        return Metaclass_TopicInfo.__constants['ID_SERVICE_SERVER']

    @property
    def ID_SERVICE_CLIENT(self) -> typing.Literal[4]:
        """Message constant 'ID_SERVICE_CLIENT'."""
        return Metaclass_TopicInfo.__constants['ID_SERVICE_CLIENT']

    @property
    def ID_MROSTOPIC_REQUEST(self) -> typing.Literal[6]:
        """Message constant 'ID_MROSTOPIC_REQUEST'."""
        return Metaclass_TopicInfo.__constants['ID_MROSTOPIC_REQUEST']

    @property
    def ID_REMOVE_PUBLISHER(self) -> typing.Literal[7]:
        """Message constant 'ID_REMOVE_PUBLISHER'."""
        return Metaclass_TopicInfo.__constants['ID_REMOVE_PUBLISHER']

    @property
    def ID_REMOVE_SUBSCRIBER(self) -> typing.Literal[8]:
        """Message constant 'ID_REMOVE_SUBSCRIBER'."""
        return Metaclass_TopicInfo.__constants['ID_REMOVE_SUBSCRIBER']

    @property
    def ID_REMOVE_SERVICE_SERVER(self) -> typing.Literal[9]:
        """Message constant 'ID_REMOVE_SERVICE_SERVER'."""
        return Metaclass_TopicInfo.__constants['ID_REMOVE_SERVICE_SERVER']

    @property
    def ID_REMOVE_SERVICE_CLIENT(self) -> typing.Literal[11]:
        """Message constant 'ID_REMOVE_SERVICE_CLIENT'."""
        return Metaclass_TopicInfo.__constants['ID_REMOVE_SERVICE_CLIENT']

    @property
    def ID_MROSSERVICE_REQUEST(self) -> typing.Literal[13]:
        """Message constant 'ID_MROSSERVICE_REQUEST'."""
        return Metaclass_TopicInfo.__constants['ID_MROSSERVICE_REQUEST']

    @property
    def ID_LOG(self) -> typing.Literal[14]:
        """Message constant 'ID_LOG'."""
        return Metaclass_TopicInfo.__constants['ID_LOG']

    @property
    def ID_TIME(self) -> typing.Literal[15]:
        """Message constant 'ID_TIME'."""
        return Metaclass_TopicInfo.__constants['ID_TIME']

    @property
    def ID_NEGOTIATED(self) -> typing.Literal[16]:
        """Message constant 'ID_NEGOTIATED'."""
        return Metaclass_TopicInfo.__constants['ID_NEGOTIATED']

    @property
    def ID_SESSION_ID(self) -> typing.Literal[17]:
        """Message constant 'ID_SESSION_ID'."""
        return Metaclass_TopicInfo.__constants['ID_SESSION_ID']

    @property
    def ID_ASHMEM_INFO(self) -> typing.Literal[18]:
        """Message constant 'ID_ASHMEM_INFO'."""
        return Metaclass_TopicInfo.__constants['ID_ASHMEM_INFO']

    @property
    def ID_DIAG(self) -> typing.Literal[19]:
        """Message constant 'ID_DIAG'."""
        return Metaclass_TopicInfo.__constants['ID_DIAG']


class TopicInfo(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_TopicInfo):
    """
    ...
    def __init__(self, *,
                 topic_id: typing.Optional[int] = None,  # noqa: E501
                 topic_name: typing.Optional[str] = None,  # noqa: E501
                 message_type: typing.Optional[str] = None,  # noqa: E501
                 md5sum: typing.Optional[str] = None,  # noqa: E501
                 buffer_size: typing.Optional[int] = None,  # noqa: E501
                 negotiated: typing.Optional[bool] = None,  # noqa: E501
                 node: typing.Optional[str] = None,  # noqa: E501
                 definition: typing.Optional[str] = None,  # noqa: E501
                 latch: typing.Optional[bool] = None,  # noqa: E501
                 reliable: typing.Optional[bool] = None,  # noqa: E501
                 queue_size: typing.Optional[int] = None,  # noqa: E501
                 enabled: typing.Optional[int] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
            self._check_fields = ros_python_check_fields == '1'
        self.topic_id = topic_id if topic_id is not None else int()
        self.topic_name = topic_name if topic_name is not None else str()
        self.message_type = message_type if message_type is not None else str()
        self.md5sum = md5sum if md5sum is not None else str()
        self.buffer_size = buffer_size if buffer_size is not None else int()
        self.negotiated = negotiated if negotiated is not None else bool()
        self.node = node if node is not None else str()
        self.definition = definition if definition is not None else str()
        self.latch = latch if latch is not None else bool()
        self.reliable = reliable if reliable is not None else bool()
        self.queue_size = queue_size if queue_size is not None else int()
        self.enabled = enabled if enabled is not None else int()
    ...
    @topic_name.setter
    def topic_name(self, value: str) -> None:
    ...
    @md5sum.setter
    def md5sum(self, value: str) -> None:
    ...
    @negotiated.setter
    def negotiated(self, value: bool) -> None:
    ...
    @reliable.setter
    def reliable(self, value: bool) -> None:
