...
mros_msgs__msg__TopicStatistics__create(void)
{
...
mros_msgs__msg__TopicStatistics__Sequence__init(mros_msgs__msg__TopicStatistics__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(mros_msgs__msg__TopicStatistics)) {
      return false;
    }
  ...
  mros_msgs__msg__TopicStatistics__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(mros_msgs__msg__TopicStatistics)) {
      return false;
    }
