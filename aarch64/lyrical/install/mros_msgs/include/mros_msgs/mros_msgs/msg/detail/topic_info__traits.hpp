...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, mros_msgs::msg::TopicInfo>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    ...
    std::forward<T>(msg).md5sum,
    std::forward<T>(msg).buffer_size,
    std::forward<T>(msg).negotiated,
    std::forward<T>(msg).node,
    std::forward<T>(msg).definition,
    std::forward<T>(msg).latch,
    std::forward<T>(msg).reliable,
    std::forward<T>(msg).queue_size,
...
template<>
constexpr const char * data_type<mros_msgs::msg::TopicInfo>()
{
  return "mros_msgs::msg::TopicInfo";
}

template<>
constexpr const char * name<mros_msgs::msg::TopicInfo>()
{
  return "mros_msgs/msg/TopicInfo";
}
...
template<>
struct MessageTraits<mros_msgs::msg::TopicInfo>
{
