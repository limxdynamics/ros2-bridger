...
bool limx_arm_msgs__msg__joint_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("limx_arm_msgs.msg._joint_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("JointData", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
