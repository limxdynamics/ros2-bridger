...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::msg::arm_status>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).left_joints,
    std::forward<T>(msg).right_joints,
    std::forward<T>(msg).left_endEffector,
    std::forward<T>(msg).right_endEffector,
    std::forward<T>(msg).ik_statu);
}
...
template<>
constexpr const char * data_type<limx_arm_msgs::msg::arm_status>()
{
  return "limx_arm_msgs::msg::arm_status";
}

template<>
constexpr const char * name<limx_arm_msgs::msg::arm_status>()
{
  return "limx_arm_msgs/msg/arm_status";
}
...
template<>
struct MessageTraits<limx_arm_msgs::msg::arm_status>
{
