...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::srv::gripper_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).initial,
    std::forward<T>(msg).dis,
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::gripper_Request>()
{
  return "limx_arm_msgs::srv::gripper_Request";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::gripper_Request>()
{
  return "limx_arm_msgs/srv/gripper_Request";
}
...
template<>
struct MessageTraits<limx_arm_msgs::srv::gripper_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::srv::gripper_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::gripper_Response>()
{
  return "limx_arm_msgs::srv::gripper_Response";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::gripper_Response>()
{
  return "limx_arm_msgs/srv/gripper_Response";
}
...
template<>
struct MessageTraits<limx_arm_msgs::srv::gripper_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::srv::gripper_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::gripper_Event>()
{
  return "limx_arm_msgs::srv::gripper_Event";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::gripper_Event>()
{
  return "limx_arm_msgs/srv/gripper_Event";
}
...
template<>
struct MessageTraits<limx_arm_msgs::srv::gripper_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::gripper>()
{
  return "limx_arm_msgs::srv::gripper";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::gripper>()
{
  return "limx_arm_msgs/srv/gripper";
}
