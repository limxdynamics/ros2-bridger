...
limx_arm_msgs__srv__gripper_Request__create(void)
{
...
limx_arm_msgs__srv__gripper_Request__Sequence__init(limx_arm_msgs__srv__gripper_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(limx_arm_msgs__srv__gripper_Request)) {
      return false;
    }
  ...
  limx_arm_msgs__srv__gripper_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(limx_arm_msgs__srv__gripper_Request)) {
      return false;
    }
    ...
    limx_arm_msgs__srv__gripper_Request * data =
      (limx_arm_msgs__srv__gripper_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limx_arm_msgs__srv__gripper_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          limx_arm_msgs__srv__gripper_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
limx_arm_msgs__srv__gripper_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
limx_arm_msgs__srv__gripper_Response__Sequence__init(limx_arm_msgs__srv__gripper_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(limx_arm_msgs__srv__gripper_Response)) {
      return false;
    }
  ...
  limx_arm_msgs__srv__gripper_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(limx_arm_msgs__srv__gripper_Response)) {
      return false;
    }
    const size_t allocation_size =
    ...
    limx_arm_msgs__srv__gripper_Response * data =
      (limx_arm_msgs__srv__gripper_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limx_arm_msgs__srv__gripper_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          limx_arm_msgs__srv__gripper_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
limx_arm_msgs__srv__gripper_Event__init(limx_arm_msgs__srv__gripper_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    limx_arm_msgs__srv__gripper_Event__fini(msg);
    return false;
  }
  // request
  if (!limx_arm_msgs__srv__gripper_Request__Sequence__init(&msg->request, 0)) {
    limx_arm_msgs__srv__gripper_Event__fini(msg);
    return false;
  }
  // response
  if (!limx_arm_msgs__srv__gripper_Response__Sequence__init(&msg->response, 0)) {
    limx_arm_msgs__srv__gripper_Event__fini(msg);
    return false;
  }
  return true;
...
void
limx_arm_msgs__srv__gripper_Event__fini(limx_arm_msgs__srv__gripper_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  limx_arm_msgs__srv__gripper_Request__Sequence__fini(&msg->request);
  // response
  limx_arm_msgs__srv__gripper_Response__Sequence__fini(&msg->response);
}

bool
limx_arm_msgs__srv__gripper_Event__are_equal(const limx_arm_msgs__srv__gripper_Event * lhs, const limx_arm_msgs__srv__gripper_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!limx_arm_msgs__srv__gripper_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!limx_arm_msgs__srv__gripper_Response__Sequence__are_equal(
...
bool
limx_arm_msgs__srv__gripper_Event__copy(
  const limx_arm_msgs__srv__gripper_Event * input,
  limx_arm_msgs__srv__gripper_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!limx_arm_msgs__srv__gripper_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!limx_arm_msgs__srv__gripper_Response__Sequence__copy(
...
limx_arm_msgs__srv__gripper_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limx_arm_msgs__srv__gripper_Event * msg = (limx_arm_msgs__srv__gripper_Event *)allocator.allocate(sizeof(limx_arm_msgs__srv__gripper_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(limx_arm_msgs__srv__gripper_Event));
  bool success = limx_arm_msgs__srv__gripper_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
limx_arm_msgs__srv__gripper_Event__destroy(limx_arm_msgs__srv__gripper_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    limx_arm_msgs__srv__gripper_Event__fini(msg);
...
bool
limx_arm_msgs__srv__gripper_Event__Sequence__init(limx_arm_msgs__srv__gripper_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limx_arm_msgs__srv__gripper_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(limx_arm_msgs__srv__gripper_Event)) {
      return false;
    }
    data = (limx_arm_msgs__srv__gripper_Event *)allocator.zero_allocate(size, sizeof(limx_arm_msgs__srv__gripper_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = limx_arm_msgs__srv__gripper_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        limx_arm_msgs__srv__gripper_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
limx_arm_msgs__srv__gripper_Event__Sequence__fini(limx_arm_msgs__srv__gripper_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      limx_arm_msgs__srv__gripper_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
limx_arm_msgs__srv__gripper_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  limx_arm_msgs__srv__gripper_Event__Sequence * array = (limx_arm_msgs__srv__gripper_Event__Sequence *)allocator.allocate(sizeof(limx_arm_msgs__srv__gripper_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = limx_arm_msgs__srv__gripper_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
limx_arm_msgs__srv__gripper_Event__Sequence__destroy(limx_arm_msgs__srv__gripper_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    limx_arm_msgs__srv__gripper_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
limx_arm_msgs__srv__gripper_Event__Sequence__are_equal(const limx_arm_msgs__srv__gripper_Event__Sequence * lhs, const limx_arm_msgs__srv__gripper_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!limx_arm_msgs__srv__gripper_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
limx_arm_msgs__srv__gripper_Event__Sequence__copy(
  const limx_arm_msgs__srv__gripper_Event__Sequence * input,
  limx_arm_msgs__srv__gripper_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(limx_arm_msgs__srv__gripper_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(limx_arm_msgs__srv__gripper_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    limx_arm_msgs__srv__gripper_Event * data =
      (limx_arm_msgs__srv__gripper_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limx_arm_msgs__srv__gripper_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          limx_arm_msgs__srv__gripper_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!limx_arm_msgs__srv__gripper_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
