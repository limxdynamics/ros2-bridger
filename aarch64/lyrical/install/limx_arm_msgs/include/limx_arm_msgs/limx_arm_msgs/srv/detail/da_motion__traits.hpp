...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::srv::DA_motion_Request>, int> = 0>
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::DA_motion_Request>()
{
  return "limx_arm_msgs::srv::DA_motion_Request";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::DA_motion_Request>()
{
  return "limx_arm_msgs/srv/DA_motion_Request";
}
...
template<>
struct MessageTraits<limx_arm_msgs::srv::DA_motion_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::srv::DA_motion_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::DA_motion_Response>()
{
  return "limx_arm_msgs::srv::DA_motion_Response";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::DA_motion_Response>()
{
  return "limx_arm_msgs/srv/DA_motion_Response";
}
...
template<>
struct MessageTraits<limx_arm_msgs::srv::DA_motion_Response>
{
...
inline std::string to_yaml(const DA_motion_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, limx_arm_msgs::srv::DA_motion_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::DA_motion_Event>()
{
  return "limx_arm_msgs::srv::DA_motion_Event";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::DA_motion_Event>()
{
  return "limx_arm_msgs/srv/DA_motion_Event";
}

template<>
struct has_fixed_size<limx_arm_msgs::srv::DA_motion_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<limx_arm_msgs::srv::DA_motion_Event>
  : std::integral_constant<bool, has_bounded_size<limx_arm_msgs::srv::DA_motion_Request>::value && has_bounded_size<limx_arm_msgs::srv::DA_motion_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<limx_arm_msgs::srv::DA_motion_Event>
  : std::true_type {};

template<>
struct MessageTraits<limx_arm_msgs::srv::DA_motion_Event>
{
...
template<>
constexpr const char * data_type<limx_arm_msgs::srv::DA_motion>()
{
  return "limx_arm_msgs::srv::DA_motion";
}

template<>
constexpr const char * name<limx_arm_msgs::srv::DA_motion>()
{
  return "limx_arm_msgs/srv/DA_motion";
}
