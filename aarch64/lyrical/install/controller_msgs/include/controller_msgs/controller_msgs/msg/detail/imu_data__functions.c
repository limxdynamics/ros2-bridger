...
controller_msgs__msg__IMUData__create(void)
{
...
controller_msgs__msg__IMUData__Sequence__init(controller_msgs__msg__IMUData__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(controller_msgs__msg__IMUData)) {
      return false;
    }
  ...
  controller_msgs__msg__IMUData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(controller_msgs__msg__IMUData)) {
      return false;
    }
