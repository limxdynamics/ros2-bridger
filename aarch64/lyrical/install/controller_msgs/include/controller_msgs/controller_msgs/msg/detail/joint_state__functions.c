...
controller_msgs__msg__JointState__create(void)
{
...
controller_msgs__msg__JointState__Sequence__init(controller_msgs__msg__JointState__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(controller_msgs__msg__JointState)) {
      return false;
    }
  ...
  controller_msgs__msg__JointState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(controller_msgs__msg__JointState)) {
      return false;
    }
    ...
    controller_msgs__msg__JointState * data =
      (controller_msgs__msg__JointState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!controller_msgs__msg__JointState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          controller_msgs__msg__JointState__fini(&output->data[i]);
        }
        return false;
      }
    }
