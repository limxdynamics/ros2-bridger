...
struct IMUData_
{
  ...
  : header(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->imustamp = 0ull;
      this->status = 0ul;
      std::fill(this->euler.begin(), this->euler.end(), 0.0);
      std::fill(this->quat.begin(), this->quat.end(), 0.0);
      std::fill(this->acc.begin(), this->acc.end(), 0.0);
      std::fill(this->gyro.begin(), this->gyro.end(), 0.0);
    }
  }
