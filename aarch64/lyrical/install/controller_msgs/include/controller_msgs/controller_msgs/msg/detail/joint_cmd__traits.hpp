...
// IWYU pragma: private, include "controller_msgs/msg/joint_cmd.hpp"
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, controller_msgs::msg::JointCmd>, int> = 0>
...
template<>
constexpr const char * data_type<controller_msgs::msg::JointCmd>()
{
  return "controller_msgs::msg::JointCmd";
}

template<>
constexpr const char * name<controller_msgs::msg::JointCmd>()
{
  return "controller_msgs/msg/JointCmd";
}
...
template<>
struct MessageTraits<controller_msgs::msg::JointCmd>
{
