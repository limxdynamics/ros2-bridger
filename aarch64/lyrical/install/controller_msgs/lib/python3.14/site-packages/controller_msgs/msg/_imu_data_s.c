...
bool controller_msgs__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_msgs.msg._imu_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
  ...
  controller_msgs__msg__IMUData * ros_message = _ros_message;
  {  // header
  ...
  {  // imustamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "imustamp");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->imustamp = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // status
...
PyObject * controller_msgs__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller_msgs.msg._imu_data");
  ...
  {  // imustamp
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->imustamp);
    {
      int rc = PyObject_SetAttrString(_pymessage, "imustamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
