...
class Init_SetUint8ArrayWithTitle_Event_response
{
public:
  explicit Init_SetUint8ArrayWithTitle_Event_response(::std_srvs::srv::SetUint8ArrayWithTitle_Event & msg)
  : msg_(msg)
  {}
  ::std_srvs::srv::SetUint8ArrayWithTitle_Event response(::std_srvs::srv::SetUint8ArrayWithTitle_Event::_response_type arg)
  {
...
private:
  ::std_srvs::srv::SetUint8ArrayWithTitle_Event msg_;
};

class Init_SetUint8ArrayWithTitle_Event_request
{
public:
  explicit Init_SetUint8ArrayWithTitle_Event_request(::std_srvs::srv::SetUint8ArrayWithTitle_Event & msg)
  : msg_(msg)
  {}
  Init_SetUint8ArrayWithTitle_Event_response request(::std_srvs::srv::SetUint8ArrayWithTitle_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetUint8ArrayWithTitle_Event_response(msg_);
  }
...
class Init_SetUint8ArrayWithTitle_Event_info
{
public:
  Init_SetUint8ArrayWithTitle_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetUint8ArrayWithTitle_Event_request info(::std_srvs::srv::SetUint8ArrayWithTitle_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetUint8ArrayWithTitle_Event_request(msg_);
  }
...
template<>
inline
auto build<::std_srvs::srv::SetUint8ArrayWithTitle_Event>()
{
  return std_srvs::srv::builder::Init_SetUint8ArrayWithTitle_Event_info();
}
