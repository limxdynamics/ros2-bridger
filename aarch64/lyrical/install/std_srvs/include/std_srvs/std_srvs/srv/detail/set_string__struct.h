...
enum
{
  std_srvs__srv__SetString_Event__request__MAX_SIZE = 1
};
// response
enum
{
  std_srvs__srv__SetString_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetString in the package std_srvs.
typedef struct std_srvs__srv__SetString_Event
{
  service_msgs__msg__ServiceEventInfo info;
  std_srvs__srv__SetString_Request__Sequence request;
  std_srvs__srv__SetString_Response__Sequence response;
} std_srvs__srv__SetString_Event;

// Struct for a sequence of std_srvs__srv__SetString_Event.
typedef struct std_srvs__srv__SetString_Event__Sequence
{
