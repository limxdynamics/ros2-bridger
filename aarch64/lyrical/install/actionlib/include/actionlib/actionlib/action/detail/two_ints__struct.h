...
enum
{
  actionlib__action__TwoInts_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  actionlib__action__TwoInts_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/TwoInts in the package actionlib.
typedef struct actionlib__action__TwoInts_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  actionlib__action__TwoInts_SendGoal_Request__Sequence request;
  actionlib__action__TwoInts_SendGoal_Response__Sequence response;
} actionlib__action__TwoInts_SendGoal_Event;

// Struct for a sequence of actionlib__action__TwoInts_SendGoal_Event.
typedef struct actionlib__action__TwoInts_SendGoal_Event__Sequence
{
...
enum
{
  actionlib__action__TwoInts_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  actionlib__action__TwoInts_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/TwoInts in the package actionlib.
typedef struct actionlib__action__TwoInts_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  actionlib__action__TwoInts_GetResult_Request__Sequence request;
  actionlib__action__TwoInts_GetResult_Response__Sequence response;
} actionlib__action__TwoInts_GetResult_Event;

// Struct for a sequence of actionlib__action__TwoInts_GetResult_Event.
typedef struct actionlib__action__TwoInts_GetResult_Event__Sequence
{
