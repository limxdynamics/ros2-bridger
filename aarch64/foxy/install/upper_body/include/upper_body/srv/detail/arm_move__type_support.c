...
static rosidl_typesupport_introspection_c__MessageMember arm_move_Request__rosidl_typesupport_introspection_c__arm_move_Request_message_member_array[6] = {
  {
    "move_type",  // name
