  ...
  std_srvs__srv__GetUint8Array_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    std_srvs__srv__GetUint8Array_Request * data =
      (std_srvs__srv__GetUint8Array_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_srvs__srv__GetUint8Array_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          std_srvs__srv__GetUint8Array_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  std_srvs__srv__GetUint8Array_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    std_srvs__srv__GetUint8Array_Response * data =
      (std_srvs__srv__GetUint8Array_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_srvs__srv__GetUint8Array_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          std_srvs__srv__GetUint8Array_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
