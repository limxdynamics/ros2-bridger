...
struct GetDiscoveryInfo_Response_
{
  ...
  // field types and members
  using _nodes_type =
    std::vector<mros_msgs::msg::NodeInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<mros_msgs::msg::NodeInfo_<ContainerAllocator>>::other>;
  _nodes_type nodes;
  using _subscribers_type =
    std::vector<mros_msgs::msg::TopicInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<mros_msgs::msg::TopicInfo_<ContainerAllocator>>::other>;
  ...
  Type & set__nodes(
    const std::vector<mros_msgs::msg::NodeInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<mros_msgs::msg::NodeInfo_<ContainerAllocator>>::other> & _arg)
  {
    this->nodes = _arg;
    return *this;
  }
  Type & set__subscribers(
    const std::vector<mros_msgs::msg::TopicInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<mros_msgs::msg::TopicInfo_<ContainerAllocator>>::other> & _arg)
  {
