...
bool mros_msgs__msg__node_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mros_msgs.msg._node_info.NodeInfo", full_classname_dest, 33) == 0);
  }
  mros_msgs__msg__NodeInfo * ros_message = _ros_message;
  {  // node_name
...
{
  /* NOTE(esteve): Call constructor of NodeInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mros_msgs.msg._node_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodeInfo");
