...
bool limx_arm_msgs__msg__joint_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("limx_arm_msgs.msg._joint_data.JointData", full_classname_dest, 39) == 0);
  }
  limx_arm_msgs__msg__JointData * ros_message = _ros_message;
  {  // stamp
...
PyObject * limx_arm_msgs__msg__joint_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("limx_arm_msgs.msg._joint_data");
