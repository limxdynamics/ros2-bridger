...
class arm_status(metaclass=Metaclass_arm_status):
    ...
    def __init__(self, **kwargs):
        ...
        if 'left_endEffector' not in kwargs:
            ...
            self.left_endEffector = numpy.array(kwargs.get('left_endEffector'), dtype=numpy.float64)
            assert self.left_endEffector.shape == (7, )
        if 'right_endEffector' not in kwargs:
            self.right_endEffector = numpy.zeros(7, dtype=numpy.float64)
        else:
            self.right_endEffector = numpy.array(kwargs.get('right_endEffector'), dtype=numpy.float64)
            assert self.right_endEffector.shape == (7, )
    ...
    def __eq__(self, other):
        ...
        if self.right_joints != other.right_joints:
            return False
        if all(self.left_endEffector != other.left_endEffector):
            return False
        if all(self.right_endEffector != other.right_endEffector):
            return False
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'left_joints' field must be a set or sequence and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'right_joints' field must be a set or sequence and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'left_endEffector' field must be a set or sequence with length 7 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'right_endEffector' field must be a set or sequence with length 7 and each value of type 'float'"
