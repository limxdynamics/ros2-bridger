...
struct JointStatus_
{
  ...
  explicit JointStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>, 6>::iterator, std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>>(this->error.begin(), this->error.end(), "");
  ...
  _enable_type enable;
  using _error_type =
    std::array<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>, 6>;
  _error_type error;
  using _zero_type =
    std::array<float, 6>;
  _zero_type zero;
  ...
  Type & set__error(
    const std::array<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>, 6> & _arg)
  {
    this->error = _arg;
    return *this;
  }
