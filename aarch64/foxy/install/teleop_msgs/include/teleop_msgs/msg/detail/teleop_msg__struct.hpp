...
struct TeleopMsg_
{
  ...
  _world_type world;
  using _anchors_type =
    std::vector<teleop_msgs::msg::KeyPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<teleop_msgs::msg::KeyPoint_<ContainerAllocator>>::other>;
  ...
  Type & set__anchors(
    const std::vector<teleop_msgs::msg::KeyPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<teleop_msgs::msg::KeyPoint_<ContainerAllocator>>::other> & _arg)
  {
    this->anchors = _arg;
    return *this;
  }
