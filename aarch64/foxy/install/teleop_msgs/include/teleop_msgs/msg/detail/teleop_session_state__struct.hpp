...
struct TeleopSessionState_
{
  ...
  _mode_type mode;
  using _limbs_type =
    std::vector<teleop_msgs::msg::TeleopLimbState_<ContainerAllocator>, typename ContainerAllocator::template rebind<teleop_msgs::msg::TeleopLimbState_<ContainerAllocator>>::other>;
  _limbs_type limbs;
  ...
  Type & set__limbs(
    const std::vector<teleop_msgs::msg::TeleopLimbState_<ContainerAllocator>, typename ContainerAllocator::template rebind<teleop_msgs::msg::TeleopLimbState_<ContainerAllocator>>::other> & _arg)
  {
    this->limbs = _arg;
    return *this;
  }
