...
bool teleop_msgs__msg__key_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_msgs.msg._key_point.KeyPoint", full_classname_dest, 35) == 0);
  }
  teleop_msgs__msg__KeyPoint * ros_message = _ros_message;
  {  // name
...
PyObject * teleop_msgs__msg__key_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("teleop_msgs.msg._key_point");
