...
void fetch_function__JointCmdNew__names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__JointCmdNew__names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__JointCmdNew__names(untyped_member, index));
...
void fetch_function__JointCmdNew__q(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__JointCmdNew__q(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__q(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__JointCmdNew__q(untyped_member, index));
...
void fetch_function__JointCmdNew__v(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__JointCmdNew__v(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__v(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__JointCmdNew__v(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__JointCmdNew__tau(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__JointCmdNew__tau(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__tau(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__JointCmdNew__tau(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__JointCmdNew__kp(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__JointCmdNew__kp(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__kp(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__JointCmdNew__kp(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__JointCmdNew__kd(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__JointCmdNew__kd(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__kd(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__JointCmdNew__kd(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__JointCmdNew__mode(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__JointCmdNew__mode(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__JointCmdNew__mode(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__JointCmdNew__mode(untyped_member, index));
...
size_t size_function__JointCmdNew__parallel_solve_required(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<bool> *>(untyped_member);
  return member->size();
}

void fetch_function__JointCmdNew__parallel_solve_required(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & member = *reinterpret_cast<const std::vector<bool> *>(untyped_member);
...
void assign_function__JointCmdNew__parallel_solve_required(
  void * untyped_member, size_t index, const void * untyped_value)
{
...
void resize_function__JointCmdNew__parallel_solve_required(void * untyped_member, size_t size)
{
  auto * member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointCmdNew_message_member_array[10] = {
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__names,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__names,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__q,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__q,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__v,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__v,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__tau,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__tau,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__kp,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__kp,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__kd,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__kd,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointCmdNew__mode,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__mode,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    nullptr,  // default value
    size_function__JointCmdNew__parallel_solve_required,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
    fetch_function__JointCmdNew__parallel_solve_required,  // fetch(index, &value) function pointer
    assign_function__JointCmdNew__parallel_solve_required,  // assign(index, value) function pointer
    resize_function__JointCmdNew__parallel_solve_required  // resize(index) function pointer
  }
};
