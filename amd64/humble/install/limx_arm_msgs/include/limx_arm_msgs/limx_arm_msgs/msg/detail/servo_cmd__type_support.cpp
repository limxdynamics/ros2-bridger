...
void fetch_function__ServoCmd__left_arm_pos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__ServoCmd__left_arm_pos(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__ServoCmd__left_arm_pos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__ServoCmd__left_arm_pos(untyped_member, index));
...
void fetch_function__ServoCmd__right_arm_pos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__ServoCmd__right_arm_pos(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__ServoCmd__right_arm_pos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__ServoCmd__right_arm_pos(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServoCmd_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__ServoCmd__left_arm_pos,  // fetch(index, &value) function pointer
    assign_function__ServoCmd__left_arm_pos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "right_arm_pos",  // name
    ...
    fetch_function__ServoCmd__right_arm_pos,  // fetch(index, &value) function pointer
    assign_function__ServoCmd__right_arm_pos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
