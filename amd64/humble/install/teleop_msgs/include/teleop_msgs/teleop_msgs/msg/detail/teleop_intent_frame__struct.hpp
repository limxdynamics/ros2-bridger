...
struct TeleopIntentFrame_
{
  ...
  using _targets_type =
    std::vector<teleop_msgs::msg::TeleopTarget_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<teleop_msgs::msg::TeleopTarget_<ContainerAllocator>>>;
  ...
  Type & set__targets(
    const std::vector<teleop_msgs::msg::TeleopTarget_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<teleop_msgs::msg::TeleopTarget_<ContainerAllocator>>> & _arg)
  {
    this->targets = _arg;
    return *this;
  }
