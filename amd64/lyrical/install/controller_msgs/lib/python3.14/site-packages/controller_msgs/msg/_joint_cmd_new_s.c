...
bool controller_msgs__msg__joint_cmd_new__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_msgs.msg._joint_cmd_new", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("JointCmdNew", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
