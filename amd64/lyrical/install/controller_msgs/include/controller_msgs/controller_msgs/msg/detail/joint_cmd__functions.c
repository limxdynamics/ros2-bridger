...
controller_msgs__msg__JointCmd__create(void)
{
...
controller_msgs__msg__JointCmd__Sequence__init(controller_msgs__msg__JointCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(controller_msgs__msg__JointCmd)) {
      return false;
    }
  ...
  controller_msgs__msg__JointCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(controller_msgs__msg__JointCmd)) {
      return false;
    }
