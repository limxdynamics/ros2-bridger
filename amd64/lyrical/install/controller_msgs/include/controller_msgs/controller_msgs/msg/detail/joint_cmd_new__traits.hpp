...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, controller_msgs::msg::JointCmdNew>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    ...
    std::forward<T>(msg).parallel_solve_required);
}
...
template<>
constexpr const char * data_type<controller_msgs::msg::JointCmdNew>()
{
  return "controller_msgs::msg::JointCmdNew";
}

template<>
constexpr const char * name<controller_msgs::msg::JointCmdNew>()
{
  return "controller_msgs/msg/JointCmdNew";
}
...
template<>
struct MessageTraits<controller_msgs::msg::JointCmdNew>
{
