...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_msgs::msg::UInt64MultiArray>, int> = 0>
...
template<>
constexpr const char * data_type<std_msgs::msg::UInt64MultiArray>()
{
  return "std_msgs::msg::UInt64MultiArray";
}

template<>
constexpr const char * name<std_msgs::msg::UInt64MultiArray>()
{
  return "std_msgs/msg/UInt64MultiArray";
}
...
template<>
struct MessageTraits<std_msgs::msg::UInt64MultiArray>
{
