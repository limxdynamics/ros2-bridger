...
class Metaclass_Int8MultiArray(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class Int8MultiArrayConstants(typing.TypedDict):
        pass

    __constants: Int8MultiArrayConstants = {
    }
...
class Int8MultiArray(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Int8MultiArray):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, Int8MultiArray):
            return False
