...
class Metaclass_UInt32Array(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    """Metaclass of message 'UInt32Array'."""
    ...
    class UInt32ArrayConstants(typing.TypedDict):
        pass

    __constants: UInt32ArrayConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            logger = logging.getLogger(
                'std_msgs.msg.UInt32Array')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__u_int32_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__u_int32_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__u_int32_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__u_int32_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__u_int32_array
...
class UInt32Array(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_UInt32Array):
    """Message class 'UInt32Array'."""
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, UInt32Array):
            return False
