...
bool std_msgs__msg__int64_multi_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._int64_multi_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("Int64MultiArray", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
