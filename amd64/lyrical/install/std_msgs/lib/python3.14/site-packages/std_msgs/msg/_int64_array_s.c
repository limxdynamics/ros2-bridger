...
bool std_msgs__msg__int64_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._int64_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 25) == 0);
    assert(strncmp("Int64Array", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  std_msgs__msg__Int64Array * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Int64Array */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._int64_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Int64Array");
