...
class Time(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Time):
    ...
    def __init__(self, *,
                 data: typing.Optional[builtin_interfaces.msg.Time] = None,  # noqa: E501
        ...
        from builtin_interfaces.msg import Time
        self.data = data if data is not None else Time()
    ...
    @builtins.property
    def data(self) -> builtin_interfaces.msg.Time:
        """Message field 'data'."""
        return self._data

    @data.setter
    def data(self, value: builtin_interfaces.msg.Time) -> None:
        from builtin_interfaces.msg import Time
