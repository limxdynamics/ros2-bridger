...
bool std_msgs__msg__multi_array_layout__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._multi_array_layout", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("MultiArrayLayout", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
