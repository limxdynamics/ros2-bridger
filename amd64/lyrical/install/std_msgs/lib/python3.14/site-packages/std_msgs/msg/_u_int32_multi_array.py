...
class Metaclass_UInt32MultiArray(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class UInt32MultiArrayConstants(typing.TypedDict):
        pass

    __constants: UInt32MultiArrayConstants = {
    }
...
class UInt32MultiArray(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_UInt32MultiArray):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, UInt32MultiArray):
            return False
