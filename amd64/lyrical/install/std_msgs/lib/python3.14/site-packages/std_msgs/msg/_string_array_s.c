...
bool std_msgs__msg__string_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("std_msgs.msg._string_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("StringArray", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  std_msgs__msg__StringArray * ros_message = _ros_message;
  {  // header
...
PyObject * std_msgs__msg__string_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._string_array");
