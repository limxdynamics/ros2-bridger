...
class Metaclass_UInt16MultiArray(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class UInt16MultiArrayConstants(typing.TypedDict):
        pass

    __constants: UInt16MultiArrayConstants = {
    }
...
class UInt16MultiArray(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_UInt16MultiArray):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, UInt16MultiArray):
            return False
