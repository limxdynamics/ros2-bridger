...
hand_msgs__msg__HandCmd__create(void)
{
...
hand_msgs__msg__HandCmd__Sequence__init(hand_msgs__msg__HandCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(hand_msgs__msg__HandCmd)) {
      return false;
    }
  ...
  hand_msgs__msg__HandCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(hand_msgs__msg__HandCmd)) {
      return false;
    }
    ...
    hand_msgs__msg__HandCmd * data =
      (hand_msgs__msg__HandCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hand_msgs__msg__HandCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hand_msgs__msg__HandCmd__fini(&output->data[i]);
        }
        return false;
      }
    }
