...
// IWYU pragma: private, include "hand_msgs/msg/hand_cmd.hpp"
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, hand_msgs::msg::HandCmd>, int> = 0>
...
template<>
constexpr const char * data_type<hand_msgs::msg::HandCmd>()
{
  return "hand_msgs::msg::HandCmd";
}

template<>
constexpr const char * name<hand_msgs::msg::HandCmd>()
{
  return "hand_msgs/msg/HandCmd";
}
...
template<>
struct MessageTraits<hand_msgs::msg::HandCmd>
{
