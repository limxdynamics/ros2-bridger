...
bool hand_msgs__msg__hand_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hand_msgs.msg._hand_cmd", (char *)PyUnicode_1BYTE_DATA(module_attr), 23) == 0);
    assert(strncmp("HandCmd", (char *)PyUnicode_1BYTE_DATA(name_attr), 7) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  hand_msgs__msg__HandCmd * ros_message = _ros_message;
  {  // header
...
PyObject * hand_msgs__msg__hand_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hand_msgs.msg._hand_cmd");
