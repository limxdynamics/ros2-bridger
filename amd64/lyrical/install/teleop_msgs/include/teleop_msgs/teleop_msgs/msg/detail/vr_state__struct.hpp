...
struct VRState_
{
  ...
  : header(_init)
  {
    ...
    {
      std::fill(this->eyePose.begin(), this->eyePose.end(), 0.0f);
      std::fill(this->l.begin(), this->l.end(), 0.0f);
      std::fill(this->r.begin(), this->r.end(), 0.0f);
      std::fill(this->leftJS.begin(), this->leftJS.end(), 0.0f);
      this->leftTrig = 0.0f;
      this->leftGrip = 0.0f;
      this->LThU = false;
      this->LTr = false;
      ...
      this->X = false;
      this->Y = false;
      std::fill(this->rightJS.begin(), this->rightJS.end(), 0.0f);
      this->rightTrig = 0.0f;
      this->rightGrip = 0.0f;
      this->RThU = false;
      this->RTr = false;
