...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, teleop_msgs::msg::TeleopIntentFrame>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    ...
    std::forward<T>(msg).source_mask,
    std::forward<T>(msg).reference_frame,
    std::forward<T>(msg).reference_pose,
    std::forward<T>(msg).targets,
    std::forward<T>(msg).raw_valid,
    std::forward<T>(msg).raw,
    std::forward<T>(msg).head_control_selected,
    std::forward<T>(msg).retarget_valid,
    std::forward<T>(msg).retarget_joints);
}
...
template<>
constexpr const char * data_type<teleop_msgs::msg::TeleopIntentFrame>()
{
  return "teleop_msgs::msg::TeleopIntentFrame";
}

template<>
constexpr const char * name<teleop_msgs::msg::TeleopIntentFrame>()
{
  return "teleop_msgs/msg/TeleopIntentFrame";
}
...
template<>
struct MessageTraits<teleop_msgs::msg::TeleopIntentFrame>
{
