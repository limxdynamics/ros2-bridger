...
#ifndef TELEOP_MSGS__MSG__DETAIL__VR_STATE__TYPE_SUPPORT_H_
#define TELEOP_MSGS__MSG__DETAIL__VR_STATE__TYPE_SUPPORT_H_
...
#endif  // TELEOP_MSGS__MSG__DETAIL__VR_STATE__TYPE_SUPPORT_H_
