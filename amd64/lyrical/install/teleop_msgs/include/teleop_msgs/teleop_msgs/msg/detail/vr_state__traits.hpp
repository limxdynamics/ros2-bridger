...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, teleop_msgs::msg::VRState>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).header,
    std::forward<T>(msg).eyePose,
    std::forward<T>(msg).l,
    std::forward<T>(msg).r,
    std::forward<T>(msg).leftJS,
    std::forward<T>(msg).leftTrig,
    std::forward<T>(msg).leftGrip,
    std::forward<T>(msg).LThU,
    std::forward<T>(msg).LTr,
    std::forward<T>(msg).LG,
    std::forward<T>(msg).X,
    std::forward<T>(msg).Y,
    std::forward<T>(msg).rightJS,
    std::forward<T>(msg).rightTrig,
    std::forward<T>(msg).rightGrip,
    std::forward<T>(msg).RThU,
    std::forward<T>(msg).RTr,
    std::forward<T>(msg).RG,
    std::forward<T>(msg).A,
    std::forward<T>(msg).B);
}
...
template<>
constexpr const char * data_type<teleop_msgs::msg::VRState>()
{
  return "teleop_msgs::msg::VRState";
}

template<>
constexpr const char * name<teleop_msgs::msg::VRState>()
{
  return "teleop_msgs/msg/VRState";
}
...
template<>
struct MessageTraits<teleop_msgs::msg::VRState>
{
