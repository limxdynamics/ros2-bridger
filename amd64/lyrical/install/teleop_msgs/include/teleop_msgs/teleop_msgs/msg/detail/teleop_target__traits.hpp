...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, teleop_msgs::msg::TeleopTarget>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).name,
    std::forward<T>(msg).pose,
    std::forward<T>(msg).validity,
    std::forward<T>(msg).source_stamp);
}
...
template<>
constexpr const char * data_type<teleop_msgs::msg::TeleopTarget>()
{
  return "teleop_msgs::msg::TeleopTarget";
}

template<>
constexpr const char * name<teleop_msgs::msg::TeleopTarget>()
{
  return "teleop_msgs/msg/TeleopTarget";
}
...
template<>
struct MessageTraits<teleop_msgs::msg::TeleopTarget>
{
