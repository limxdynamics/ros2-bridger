...
bool teleop_msgs__msg__teleop_limb_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_msgs.msg._teleop_limb_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("TeleopLimbState", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
