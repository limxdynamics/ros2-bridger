...
enum
{
  limx_arm_msgs__srv__DA_motion_Event__request__MAX_SIZE = 1
};
// response
enum
{
  limx_arm_msgs__srv__DA_motion_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/DA_motion in the package limx_arm_msgs.
typedef struct limx_arm_msgs__srv__DA_motion_Event
{
  service_msgs__msg__ServiceEventInfo info;
  limx_arm_msgs__srv__DA_motion_Request__Sequence request;
  limx_arm_msgs__srv__DA_motion_Response__Sequence response;
} limx_arm_msgs__srv__DA_motion_Event;

// Struct for a sequence of limx_arm_msgs__srv__DA_motion_Event.
typedef struct limx_arm_msgs__srv__DA_motion_Event__Sequence
{
