...
struct JointStatus_
{
  ...
  explicit JointStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->deviceid = "";
      this->run_time = 0ll;
      std::fill(this->enable.begin(), this->enable.end(), 0l);
      std::fill(this->error.begin(), this->error.end(), "");
      std::fill(this->zero.begin(), this->zero.end(), 0.0f);
      std::fill(this->limit_min.begin(), this->limit_min.end(), 0.0f);
      std::fill(this->limit_max.begin(), this->limit_max.end(), 0.0f);
      std::fill(this->tool_size.begin(), this->tool_size.end(), 0.0f);
      this->mode = 0l;
      this->state = 0l;
      this->play_state = 0l;
      this->log_path = "";
