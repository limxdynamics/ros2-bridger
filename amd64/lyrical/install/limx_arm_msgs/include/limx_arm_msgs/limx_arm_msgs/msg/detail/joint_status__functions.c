...
limx_arm_msgs__msg__JointStatus__Sequence__init(limx_arm_msgs__msg__JointStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(limx_arm_msgs__msg__JointStatus)) {
      return false;
    }
  ...
  limx_arm_msgs__msg__JointStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(limx_arm_msgs__msg__JointStatus)) {
      return false;
    }
    ...
    limx_arm_msgs__msg__JointStatus * data =
      (limx_arm_msgs__msg__JointStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limx_arm_msgs__msg__JointStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          limx_arm_msgs__msg__JointStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
