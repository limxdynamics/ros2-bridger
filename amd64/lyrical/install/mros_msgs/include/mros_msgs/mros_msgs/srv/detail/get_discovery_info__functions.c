...
mros_msgs__srv__GetDiscoveryInfo_Request__create(void)
{
...
mros_msgs__srv__GetDiscoveryInfo_Request__Sequence__init(mros_msgs__srv__GetDiscoveryInfo_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(mros_msgs__srv__GetDiscoveryInfo_Request)) {
      return false;
    }
  ...
  mros_msgs__srv__GetDiscoveryInfo_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(mros_msgs__srv__GetDiscoveryInfo_Request)) {
      return false;
    }
    ...
    mros_msgs__srv__GetDiscoveryInfo_Request * data =
      (mros_msgs__srv__GetDiscoveryInfo_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mros_msgs__srv__GetDiscoveryInfo_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mros_msgs__srv__GetDiscoveryInfo_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
mros_msgs__srv__GetDiscoveryInfo_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
mros_msgs__srv__GetDiscoveryInfo_Response__Sequence__init(mros_msgs__srv__GetDiscoveryInfo_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(mros_msgs__srv__GetDiscoveryInfo_Response)) {
      return false;
    }
  ...
  mros_msgs__srv__GetDiscoveryInfo_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(mros_msgs__srv__GetDiscoveryInfo_Response)) {
      return false;
    }
    const size_t allocation_size =
    ...
    mros_msgs__srv__GetDiscoveryInfo_Response * data =
      (mros_msgs__srv__GetDiscoveryInfo_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mros_msgs__srv__GetDiscoveryInfo_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mros_msgs__srv__GetDiscoveryInfo_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
mros_msgs__srv__GetDiscoveryInfo_Event__init(mros_msgs__srv__GetDiscoveryInfo_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    mros_msgs__srv__GetDiscoveryInfo_Event__fini(msg);
    return false;
  }
  // request
  if (!mros_msgs__srv__GetDiscoveryInfo_Request__Sequence__init(&msg->request, 0)) {
    mros_msgs__srv__GetDiscoveryInfo_Event__fini(msg);
    return false;
  }
  // response
  if (!mros_msgs__srv__GetDiscoveryInfo_Response__Sequence__init(&msg->response, 0)) {
    mros_msgs__srv__GetDiscoveryInfo_Event__fini(msg);
    return false;
  }
  return true;
...
void
mros_msgs__srv__GetDiscoveryInfo_Event__fini(mros_msgs__srv__GetDiscoveryInfo_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  mros_msgs__srv__GetDiscoveryInfo_Request__Sequence__fini(&msg->request);
  // response
  mros_msgs__srv__GetDiscoveryInfo_Response__Sequence__fini(&msg->response);
}

bool
mros_msgs__srv__GetDiscoveryInfo_Event__are_equal(const mros_msgs__srv__GetDiscoveryInfo_Event * lhs, const mros_msgs__srv__GetDiscoveryInfo_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!mros_msgs__srv__GetDiscoveryInfo_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!mros_msgs__srv__GetDiscoveryInfo_Response__Sequence__are_equal(
...
bool
mros_msgs__srv__GetDiscoveryInfo_Event__copy(
  const mros_msgs__srv__GetDiscoveryInfo_Event * input,
  mros_msgs__srv__GetDiscoveryInfo_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!mros_msgs__srv__GetDiscoveryInfo_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!mros_msgs__srv__GetDiscoveryInfo_Response__Sequence__copy(
...
mros_msgs__srv__GetDiscoveryInfo_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mros_msgs__srv__GetDiscoveryInfo_Event * msg = (mros_msgs__srv__GetDiscoveryInfo_Event *)allocator.allocate(sizeof(mros_msgs__srv__GetDiscoveryInfo_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mros_msgs__srv__GetDiscoveryInfo_Event));
  bool success = mros_msgs__srv__GetDiscoveryInfo_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
mros_msgs__srv__GetDiscoveryInfo_Event__destroy(mros_msgs__srv__GetDiscoveryInfo_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mros_msgs__srv__GetDiscoveryInfo_Event__fini(msg);
...
bool
mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__init(mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mros_msgs__srv__GetDiscoveryInfo_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(mros_msgs__srv__GetDiscoveryInfo_Event)) {
      return false;
    }
    data = (mros_msgs__srv__GetDiscoveryInfo_Event *)allocator.zero_allocate(size, sizeof(mros_msgs__srv__GetDiscoveryInfo_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mros_msgs__srv__GetDiscoveryInfo_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mros_msgs__srv__GetDiscoveryInfo_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__fini(mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mros_msgs__srv__GetDiscoveryInfo_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * array = (mros_msgs__srv__GetDiscoveryInfo_Event__Sequence *)allocator.allocate(sizeof(mros_msgs__srv__GetDiscoveryInfo_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__destroy(mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__are_equal(const mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * lhs, const mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mros_msgs__srv__GetDiscoveryInfo_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
mros_msgs__srv__GetDiscoveryInfo_Event__Sequence__copy(
  const mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * input,
  mros_msgs__srv__GetDiscoveryInfo_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(mros_msgs__srv__GetDiscoveryInfo_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(mros_msgs__srv__GetDiscoveryInfo_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mros_msgs__srv__GetDiscoveryInfo_Event * data =
      (mros_msgs__srv__GetDiscoveryInfo_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mros_msgs__srv__GetDiscoveryInfo_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mros_msgs__srv__GetDiscoveryInfo_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mros_msgs__srv__GetDiscoveryInfo_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
