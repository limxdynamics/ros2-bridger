...
bool mros_msgs__srv__get_discovery_info__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mros_msgs.srv._get_discovery_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("GetDiscoveryInfo_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
bool mros_msgs__srv__get_discovery_info__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("mros_msgs.srv._get_discovery_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("GetDiscoveryInfo_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
ROSIDL_GENERATOR_C_EXPORT
bool mros_msgs__srv__get_discovery_info__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    PyObject * class_attr = PyObject_GetAttrString(_pymsg, "__class__");
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("mros_msgs.srv._get_discovery_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("GetDiscoveryInfo_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mros_msgs__srv__GetDiscoveryInfo_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!mros_msgs__srv__GetDiscoveryInfo_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mros_msgs__srv__GetDiscoveryInfo_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mros_msgs__srv__GetDiscoveryInfo_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mros_msgs__srv__get_discovery_info__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!mros_msgs__srv__GetDiscoveryInfo_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mros_msgs__srv__GetDiscoveryInfo_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mros_msgs__srv__GetDiscoveryInfo_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mros_msgs__srv__get_discovery_info__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of GetDiscoveryInfo_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mros_msgs.srv._get_discovery_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetDiscoveryInfo_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mros_msgs__srv__get_discovery_info__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mros_msgs__srv__get_discovery_info__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
