...
enum
{
  upper_body__srv__arm_move_Event__request__MAX_SIZE = 1
};
// response
enum
{
  upper_body__srv__arm_move_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/arm_move in the package upper_body.
typedef struct upper_body__srv__arm_move_Event
{
  service_msgs__msg__ServiceEventInfo info;
  upper_body__srv__arm_move_Request__Sequence request;
  upper_body__srv__arm_move_Response__Sequence response;
} upper_body__srv__arm_move_Event;

// Struct for a sequence of upper_body__srv__arm_move_Event.
typedef struct upper_body__srv__arm_move_Event__Sequence
{
