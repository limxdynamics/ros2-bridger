...
{
public:
  explicit Init_GetString_Event_response(::std_srvs::srv::GetString_Event & msg)
  : msg_(msg)
  {}
  ::std_srvs::srv::GetString_Event response(::std_srvs::srv::GetString_Event::_response_type arg)
  {
...
private:
  ::std_srvs::srv::GetString_Event msg_;
};

class Init_GetString_Event_request
{
public:
  explicit Init_GetString_Event_request(::std_srvs::srv::GetString_Event & msg)
  : msg_(msg)
  {}
  Init_GetString_Event_response request(::std_srvs::srv::GetString_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetString_Event_request info(::std_srvs::srv::GetString_Event::_info_type arg)
  {
...
template<>
inline
auto build<::std_srvs::srv::GetString_Event>()
{
  return std_srvs::srv::builder::Init_GetString_Event_info();
}
