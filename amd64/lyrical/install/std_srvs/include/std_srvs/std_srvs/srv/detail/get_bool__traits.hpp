...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_srvs::srv::GetBool_Request>, int> = 0>
...
template<>
constexpr const char * data_type<std_srvs::srv::GetBool_Request>()
{
  return "std_srvs::srv::GetBool_Request";
}

template<>
constexpr const char * name<std_srvs::srv::GetBool_Request>()
{
  return "std_srvs/srv/GetBool_Request";
}
...
template<>
struct MessageTraits<std_srvs::srv::GetBool_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_srvs::srv::GetBool_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<std_srvs::srv::GetBool_Response>()
{
  return "std_srvs::srv::GetBool_Response";
}

template<>
constexpr const char * name<std_srvs::srv::GetBool_Response>()
{
  return "std_srvs/srv/GetBool_Response";
}
...
template<>
struct MessageTraits<std_srvs::srv::GetBool_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_srvs::srv::GetBool_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<std_srvs::srv::GetBool_Event>()
{
  return "std_srvs::srv::GetBool_Event";
}

template<>
constexpr const char * name<std_srvs::srv::GetBool_Event>()
{
  return "std_srvs/srv/GetBool_Event";
}

template<>
struct has_fixed_size<std_srvs::srv::GetBool_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<std_srvs::srv::GetBool_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<std_srvs::srv::GetBool_Request>::value && has_bounded_size<std_srvs::srv::GetBool_Response>::value> {};

template<>
struct is_message<std_srvs::srv::GetBool_Event>
  : std::true_type {};

template<>
struct MessageTraits<std_srvs::srv::GetBool_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<std_srvs::srv::GetBool>()
{
  return "std_srvs::srv::GetBool";
}

template<>
constexpr const char * name<std_srvs::srv::GetBool>()
{
  return "std_srvs/srv/GetBool";
}
