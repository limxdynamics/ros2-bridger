...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_srvs::srv::SetFloat32ArrayWithTitle_Request>, int> = 0>
...
template<>
constexpr const char * data_type<std_srvs::srv::SetFloat32ArrayWithTitle_Request>()
{
  return "std_srvs::srv::SetFloat32ArrayWithTitle_Request";
}

template<>
constexpr const char * name<std_srvs::srv::SetFloat32ArrayWithTitle_Request>()
{
  return "std_srvs/srv/SetFloat32ArrayWithTitle_Request";
}
...
template<>
struct MessageTraits<std_srvs::srv::SetFloat32ArrayWithTitle_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_srvs::srv::SetFloat32ArrayWithTitle_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<std_srvs::srv::SetFloat32ArrayWithTitle_Response>()
{
  return "std_srvs::srv::SetFloat32ArrayWithTitle_Response";
}

template<>
constexpr const char * name<std_srvs::srv::SetFloat32ArrayWithTitle_Response>()
{
  return "std_srvs/srv/SetFloat32ArrayWithTitle_Response";
}
...
template<>
struct MessageTraits<std_srvs::srv::SetFloat32ArrayWithTitle_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "success",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, std_srvs::srv::SetFloat32ArrayWithTitle_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<std_srvs::srv::SetFloat32ArrayWithTitle_Event>()
{
  return "std_srvs::srv::SetFloat32ArrayWithTitle_Event";
}

template<>
constexpr const char * name<std_srvs::srv::SetFloat32ArrayWithTitle_Event>()
{
  return "std_srvs/srv/SetFloat32ArrayWithTitle_Event";
}
...
template<>
struct MessageTraits<std_srvs::srv::SetFloat32ArrayWithTitle_Event>
{
...
template<>
constexpr const char * data_type<std_srvs::srv::SetFloat32ArrayWithTitle>()
{
  return "std_srvs::srv::SetFloat32ArrayWithTitle";
}

template<>
constexpr const char * name<std_srvs::srv::SetFloat32ArrayWithTitle>()
{
  return "std_srvs/srv/SetFloat32ArrayWithTitle";
}
