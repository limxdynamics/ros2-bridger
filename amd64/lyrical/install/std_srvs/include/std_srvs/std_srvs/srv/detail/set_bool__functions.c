...
std_srvs__srv__SetBool_Request__Sequence__init(std_srvs__srv__SetBool_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(std_srvs__srv__SetBool_Request)) {
      return false;
    }
  ...
  std_srvs__srv__SetBool_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(std_srvs__srv__SetBool_Request)) {
      return false;
    }
...
std_srvs__srv__SetBool_Response__Sequence__init(std_srvs__srv__SetBool_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(std_srvs__srv__SetBool_Response)) {
      return false;
    }
  ...
  std_srvs__srv__SetBool_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(std_srvs__srv__SetBool_Response)) {
      return false;
    }
    const size_t allocation_size =
...
std_srvs__srv__SetBool_Event__Sequence__init(std_srvs__srv__SetBool_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(std_srvs__srv__SetBool_Event)) {
      return false;
    }
  ...
  std_srvs__srv__SetBool_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(std_srvs__srv__SetBool_Event)) {
      return false;
    }
    const size_t allocation_size =
