...
{
  new (message_memory) tron2_manipulation::msg::arm_status(_init);
}

void arm_status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tron2_manipulation::msg::arm_status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember arm_status_message_member_array[2] = {
  {
    ...
    offsetof(tron2_manipulation::msg::arm_status, left_arm_pos),  // bytes offset in struct
  ...
  },
  {
    ...
    7,  // array size
    false,  // is upper bound
    offsetof(tron2_manipulation::msg::arm_status, right_arm_pos),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers arm_status_message_members = {
  ...
  2,  // number of fields
  sizeof(tron2_manipulation::msg::arm_status),
...
get_message_type_support_handle<tron2_manipulation::msg::arm_status>()
{
  return &::tron2_manipulation::msg::rosidl_typesupport_introspection_cpp::arm_status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tron2_manipulation, msg, arm_status)() {
  return &::tron2_manipulation::msg::rosidl_typesupport_introspection_cpp::arm_status_message_type_support_handle;
}
