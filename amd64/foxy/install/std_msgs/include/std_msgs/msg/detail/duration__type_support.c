...
static rosidl_typesupport_introspection_c__MessageMember Duration__rosidl_typesupport_introspection_c__Duration_message_member_array[1] = {
  {
    "data",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Duration)() {
  Duration__rosidl_typesupport_introspection_c__Duration_message_member_array[0].members_ =
