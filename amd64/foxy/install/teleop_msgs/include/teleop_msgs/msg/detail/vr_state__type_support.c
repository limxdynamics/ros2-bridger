...
void VRState__rosidl_typesupport_introspection_c__VRState_init_function(
...
void VRState__rosidl_typesupport_introspection_c__VRState_fini_function(void * message_memory)
{
  teleop_msgs__msg__VRState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VRState__rosidl_typesupport_introspection_c__VRState_message_member_array[20] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers VRState__rosidl_typesupport_introspection_c__VRState_message_members = {
  "teleop_msgs__msg",  // message namespace
  "VRState",  // message name
  20,  // number of fields
  sizeof(teleop_msgs__msg__VRState),
  VRState__rosidl_typesupport_introspection_c__VRState_message_member_array,  // message members
  VRState__rosidl_typesupport_introspection_c__VRState_init_function,  // function to initialize message memory (memory has to be allocated)
  VRState__rosidl_typesupport_introspection_c__VRState_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t VRState__rosidl_typesupport_introspection_c__VRState_message_type_support_handle = {
  0,
  &VRState__rosidl_typesupport_introspection_c__VRState_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_msgs, msg, VRState)() {
  VRState__rosidl_typesupport_introspection_c__VRState_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!VRState__rosidl_typesupport_introspection_c__VRState_message_type_support_handle.typesupport_identifier) {
    VRState__rosidl_typesupport_introspection_c__VRState_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &VRState__rosidl_typesupport_introspection_c__VRState_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
