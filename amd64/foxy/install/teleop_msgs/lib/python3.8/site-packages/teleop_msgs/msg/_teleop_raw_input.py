...
class TeleopRawInput(metaclass=Metaclass_TeleopRawInput):
    ...
    def __init__(self, **kwargs):
        ...
        if 'left_stick' not in kwargs:
            ...
            self.left_stick = numpy.array(kwargs.get('left_stick'), dtype=numpy.float32)
            assert self.left_stick.shape == (2, )
        if 'right_stick' not in kwargs:
            self.right_stick = numpy.zeros(2, dtype=numpy.float32)
        else:
            self.right_stick = numpy.array(kwargs.get('right_stick'), dtype=numpy.float32)
            assert self.right_stick.shape == (2, )
    ...
    def __eq__(self, other):
        ...
        if self.right_grip != other.right_grip:
            return False
        if all(self.left_stick != other.left_stick):
            return False
        if all(self.right_stick != other.right_stick):
            return False
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'left_stick' field must be a set or sequence with length 2 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'right_stick' field must be a set or sequence with length 2 and each value of type 'float'"
