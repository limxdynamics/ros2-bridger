  ...
  tron2_manipulation__srv__arm_move_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tron2_manipulation__srv__arm_move_Request * data =
      (tron2_manipulation__srv__arm_move_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tron2_manipulation__srv__arm_move_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tron2_manipulation__srv__arm_move_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tron2_manipulation__srv__arm_move_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tron2_manipulation__srv__arm_move_Response * data =
      (tron2_manipulation__srv__arm_move_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tron2_manipulation__srv__arm_move_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tron2_manipulation__srv__arm_move_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
