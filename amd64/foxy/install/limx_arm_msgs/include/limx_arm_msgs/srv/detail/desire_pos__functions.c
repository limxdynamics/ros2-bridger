  ...
  limx_arm_msgs__srv__desire_pos_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    limx_arm_msgs__srv__desire_pos_Request * data =
      (limx_arm_msgs__srv__desire_pos_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limx_arm_msgs__srv__desire_pos_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          limx_arm_msgs__srv__desire_pos_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  limx_arm_msgs__srv__desire_pos_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    limx_arm_msgs__srv__desire_pos_Response * data =
      (limx_arm_msgs__srv__desire_pos_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!limx_arm_msgs__srv__desire_pos_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          limx_arm_msgs__srv__desire_pos_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
