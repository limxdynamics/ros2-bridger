...
class desire_pos_Request(metaclass=Metaclass_desire_pos_Request):
    ...
    def __init__(self, **kwargs):
        ...
        if 'desire_pos' not in kwargs:
            ...
            self.desire_pos = numpy.array(kwargs.get('desire_pos'), dtype=numpy.float32)
            assert self.desire_pos.shape == (6, )
    ...
    def __eq__(self, other):
        ...
        if self.taskNum != other.taskNum:
            return False
        if all(self.desire_pos != other.desire_pos):
            return False
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'desire_pos' field must be a set or sequence with length 6 and each value of type 'float'"
