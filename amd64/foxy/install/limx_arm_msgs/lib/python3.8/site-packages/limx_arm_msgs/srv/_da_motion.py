...
class DA_motion_Request(metaclass=Metaclass_DA_motion_Request):
    ...
    def __init__(self, **kwargs):
        ...
        if 'left_arm_joints' not in kwargs:
            ...
            self.left_arm_joints = numpy.array(kwargs.get('left_arm_joints'), dtype=numpy.float32)
        ...
        if 'right_arm_joints' not in kwargs:
            ...
            self.right_arm_joints = numpy.array(kwargs.get('right_arm_joints'), dtype=numpy.float32)
            assert self.right_arm_joints.shape == (7, )
        if 'headPos' not in kwargs:
            self.headPos = numpy.zeros(2, dtype=numpy.float32)
        else:
            self.headPos = numpy.array(kwargs.get('headPos'), dtype=numpy.float32)
            assert self.headPos.shape == (2, )
    ...
    def __eq__(self, other):
        ...
        if all(self.right_arm_joints != other.right_arm_joints):
            return False
        if all(self.headPos != other.headPos):
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'left_arm_joints' field must be a set or sequence with length 7 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'right_arm_joints' field must be a set or sequence with length 7 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'headPos' field must be a set or sequence with length 2 and each value of type 'float'"
