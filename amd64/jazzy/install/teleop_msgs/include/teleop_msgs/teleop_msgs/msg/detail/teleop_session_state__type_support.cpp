...
void fetch_function__TeleopSessionState__limbs(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const teleop_msgs::msg::TeleopLimbState *>(
    get_const_function__TeleopSessionState__limbs(untyped_member, index));
  auto & value = *reinterpret_cast<teleop_msgs::msg::TeleopLimbState *>(untyped_value);
  value = item;
}

void assign_function__TeleopSessionState__limbs(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<teleop_msgs::msg::TeleopLimbState *>(
    get_function__TeleopSessionState__limbs(untyped_member, index));
  const auto & value = *reinterpret_cast<const teleop_msgs::msg::TeleopLimbState *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TeleopSessionState_message_member_array[9] = {
  ...
  },
  {
    ...
    fetch_function__TeleopSessionState__limbs,  // fetch(index, &value) function pointer
    assign_function__TeleopSessionState__limbs,  // assign(index, value) function pointer
