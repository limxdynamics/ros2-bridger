...
void fetch_function__TactileState__names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__TactileState__names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__TactileState__names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__TactileState__names(untyped_member, index));
...
void fetch_function__TactileState__normal_force(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__TactileState__normal_force(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__TactileState__normal_force(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__TactileState__normal_force(untyped_member, index));
...
void fetch_function__TactileState__tangential_force(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__TactileState__tangential_force(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__TactileState__tangential_force(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__TactileState__tangential_force(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__TactileState__direction_angle(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__TactileState__direction_angle(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__TactileState__direction_angle(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__TactileState__direction_angle(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__TactileState__approximate_value(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint32_t *>(
    get_const_function__TactileState__approximate_value(untyped_member, index));
  auto & value = *reinterpret_cast<uint32_t *>(untyped_value);
  value = item;
}

void assign_function__TactileState__approximate_value(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint32_t *>(
    get_function__TactileState__approximate_value(untyped_member, index));
...
void fetch_function__TactileState__tactile_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint16_t *>(
    get_const_function__TactileState__tactile_state(untyped_member, index));
  auto & value = *reinterpret_cast<uint16_t *>(untyped_value);
  value = item;
}

void assign_function__TactileState__tactile_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint16_t *>(
    get_function__TactileState__tactile_state(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TactileState_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__TactileState__names,  // fetch(index, &value) function pointer
    assign_function__TactileState__names,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__TactileState__normal_force,  // fetch(index, &value) function pointer
    assign_function__TactileState__normal_force,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__TactileState__tangential_force,  // fetch(index, &value) function pointer
    assign_function__TactileState__tangential_force,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__TactileState__direction_angle,  // fetch(index, &value) function pointer
    assign_function__TactileState__direction_angle,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__TactileState__approximate_value,  // fetch(index, &value) function pointer
    assign_function__TactileState__approximate_value,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__TactileState__tactile_state,  // fetch(index, &value) function pointer
    assign_function__TactileState__tactile_state,  // assign(index, value) function pointer
...
static const rosidl_message_type_support_t TactileState_message_type_support_handle = {
  ...
  &hand_msgs__msg__TactileState__get_type_hash,
  &hand_msgs__msg__TactileState__get_type_description,
  &hand_msgs__msg__TactileState__get_type_description_sources,
};
