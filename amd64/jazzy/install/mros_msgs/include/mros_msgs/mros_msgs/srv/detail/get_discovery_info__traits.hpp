...
[[deprecated("use mros_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mros_msgs::srv::GetDiscoveryInfo_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mros_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mros_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const mros_msgs::srv::GetDiscoveryInfo_Event & msg)
{
  return mros_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mros_msgs::srv::GetDiscoveryInfo_Event>()
{
  return "mros_msgs::srv::GetDiscoveryInfo_Event";
}

template<>
inline const char * name<mros_msgs::srv::GetDiscoveryInfo_Event>()
{
  return "mros_msgs/srv/GetDiscoveryInfo_Event";
}
