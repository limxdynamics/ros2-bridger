...
void fetch_function__DA_motion_Request__left_arm_pos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DA_motion_Request__left_arm_pos(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Request__left_arm_pos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DA_motion_Request__left_arm_pos(untyped_member, index));
...
void fetch_function__DA_motion_Request__right_arm_pos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DA_motion_Request__right_arm_pos(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Request__right_arm_pos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DA_motion_Request__right_arm_pos(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__DA_motion_Request__left_arm_joints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DA_motion_Request__left_arm_joints(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Request__left_arm_joints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DA_motion_Request__left_arm_joints(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__DA_motion_Request__right_arm_joints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DA_motion_Request__right_arm_joints(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Request__right_arm_joints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DA_motion_Request__right_arm_joints(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__DA_motion_Request__headPos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DA_motion_Request__headPos(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Request__headPos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DA_motion_Request__headPos(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DA_motion_Request_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__DA_motion_Request__left_arm_pos,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Request__left_arm_pos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "right_arm_pos",  // name
    ...
    fetch_function__DA_motion_Request__right_arm_pos,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Request__right_arm_pos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "speed",  // name
  ...
  },
  {
    ...
    fetch_function__DA_motion_Request__left_arm_joints,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Request__left_arm_joints,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    ...
    fetch_function__DA_motion_Request__right_arm_joints,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Request__right_arm_joints,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "headPos",  // name
    ...
    fetch_function__DA_motion_Request__headPos,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Request__headPos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
...
void DA_motion_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) limx_arm_msgs::srv::DA_motion_Event(_init);
}

void DA_motion_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<limx_arm_msgs::srv::DA_motion_Event *>(message_memory);
  typed_message->~DA_motion_Event();
}

size_t size_function__DA_motion_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<limx_arm_msgs::srv::DA_motion_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__DA_motion_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<limx_arm_msgs::srv::DA_motion_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__DA_motion_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<limx_arm_msgs::srv::DA_motion_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__DA_motion_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const limx_arm_msgs::srv::DA_motion_Request *>(
    get_const_function__DA_motion_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<limx_arm_msgs::srv::DA_motion_Request *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<limx_arm_msgs::srv::DA_motion_Request *>(
    get_function__DA_motion_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const limx_arm_msgs::srv::DA_motion_Request *>(untyped_value);
  item = value;
}

void resize_function__DA_motion_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<limx_arm_msgs::srv::DA_motion_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__DA_motion_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<limx_arm_msgs::srv::DA_motion_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__DA_motion_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<limx_arm_msgs::srv::DA_motion_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__DA_motion_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<limx_arm_msgs::srv::DA_motion_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__DA_motion_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const limx_arm_msgs::srv::DA_motion_Response *>(
    get_const_function__DA_motion_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<limx_arm_msgs::srv::DA_motion_Response *>(untyped_value);
  value = item;
}

void assign_function__DA_motion_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<limx_arm_msgs::srv::DA_motion_Response *>(
    get_function__DA_motion_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const limx_arm_msgs::srv::DA_motion_Response *>(untyped_value);
  item = value;
}

void resize_function__DA_motion_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<limx_arm_msgs::srv::DA_motion_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DA_motion_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(limx_arm_msgs::srv::DA_motion_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<limx_arm_msgs::srv::DA_motion_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(limx_arm_msgs::srv::DA_motion_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__DA_motion_Event__request,  // size() function pointer
    get_const_function__DA_motion_Event__request,  // get_const(index) function pointer
    get_function__DA_motion_Event__request,  // get(index) function pointer
    fetch_function__DA_motion_Event__request,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Event__request,  // assign(index, value) function pointer
    resize_function__DA_motion_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<limx_arm_msgs::srv::DA_motion_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(limx_arm_msgs::srv::DA_motion_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__DA_motion_Event__response,  // size() function pointer
    get_const_function__DA_motion_Event__response,  // get_const(index) function pointer
    get_function__DA_motion_Event__response,  // get(index) function pointer
    fetch_function__DA_motion_Event__response,  // fetch(index, &value) function pointer
    assign_function__DA_motion_Event__response,  // assign(index, value) function pointer
    resize_function__DA_motion_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers DA_motion_Event_message_members = {
  "limx_arm_msgs::srv",  // message namespace
  "DA_motion_Event",  // message name
  3,  // number of fields
  sizeof(limx_arm_msgs::srv::DA_motion_Event),
  false,  // has_any_key_member_
  DA_motion_Event_message_member_array,  // message members
  DA_motion_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  DA_motion_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t DA_motion_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &DA_motion_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<limx_arm_msgs::srv::DA_motion_Event>()
{
  return &::limx_arm_msgs::srv::rosidl_typesupport_introspection_cpp::DA_motion_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, limx_arm_msgs, srv, DA_motion_Event)() {
  return &::limx_arm_msgs::srv::rosidl_typesupport_introspection_cpp::DA_motion_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t DA_motion_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<limx_arm_msgs::srv::DA_motion_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<limx_arm_msgs::srv::DA_motion_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<limx_arm_msgs::srv::DA_motion_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<limx_arm_msgs::srv::DA_motion>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<limx_arm_msgs::srv::DA_motion>,
...
get_service_type_support_handle<limx_arm_msgs::srv::DA_motion>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::limx_arm_msgs::srv::DA_motion_Event
      >()->data
      );
  }
