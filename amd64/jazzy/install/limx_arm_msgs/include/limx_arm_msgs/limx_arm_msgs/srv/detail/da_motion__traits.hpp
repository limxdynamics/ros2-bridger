...
[[deprecated("use limx_arm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const limx_arm_msgs::srv::DA_motion_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  limx_arm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use limx_arm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const limx_arm_msgs::srv::DA_motion_Event & msg)
{
  return limx_arm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<limx_arm_msgs::srv::DA_motion_Event>()
{
  return "limx_arm_msgs::srv::DA_motion_Event";
}

template<>
inline const char * name<limx_arm_msgs::srv::DA_motion_Event>()
{
  return "limx_arm_msgs/srv/DA_motion_Event";
}
