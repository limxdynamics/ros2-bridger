...
{
  new (message_memory) std_msgs::msg::Time(_init);
}

void Time_fini_function(void * message_memory)
{
  auto typed_message = static_cast<std_msgs::msg::Time *>(message_memory);
  typed_message->~Time();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Time_message_member_array[1] = {
  {
    ...
    offsetof(std_msgs::msg::Time, data),  // bytes offset in struct
...
get_message_type_support_handle<std_msgs::msg::Time>()
{
  return &::std_msgs::msg::rosidl_typesupport_introspection_cpp::Time_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, std_msgs, msg, Time)() {
  return &::std_msgs::msg::rosidl_typesupport_introspection_cpp::Time_message_type_support_handle;
}
