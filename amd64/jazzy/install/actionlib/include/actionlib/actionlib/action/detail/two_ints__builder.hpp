...
class Init_TwoInts_SendGoal_Event_response
{
public:
  explicit Init_TwoInts_SendGoal_Event_response(::actionlib::action::TwoInts_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::actionlib::action::TwoInts_SendGoal_Event response(::actionlib::action::TwoInts_SendGoal_Event::_response_type arg)
  {
...
private:
  ::actionlib::action::TwoInts_SendGoal_Event msg_;
};

class Init_TwoInts_SendGoal_Event_request
{
public:
  explicit Init_TwoInts_SendGoal_Event_request(::actionlib::action::TwoInts_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_TwoInts_SendGoal_Event_response request(::actionlib::action::TwoInts_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_TwoInts_SendGoal_Event_response(msg_);
  }
...
class Init_TwoInts_SendGoal_Event_info
{
public:
  Init_TwoInts_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TwoInts_SendGoal_Event_request info(::actionlib::action::TwoInts_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_TwoInts_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::actionlib::action::TwoInts_SendGoal_Event>()
{
  return actionlib::action::builder::Init_TwoInts_SendGoal_Event_info();
}
...
class Init_TwoInts_GetResult_Event_response
{
public:
  explicit Init_TwoInts_GetResult_Event_response(::actionlib::action::TwoInts_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::actionlib::action::TwoInts_GetResult_Event response(::actionlib::action::TwoInts_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::actionlib::action::TwoInts_GetResult_Event msg_;
};

class Init_TwoInts_GetResult_Event_request
{
public:
  explicit Init_TwoInts_GetResult_Event_request(::actionlib::action::TwoInts_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_TwoInts_GetResult_Event_response request(::actionlib::action::TwoInts_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_TwoInts_GetResult_Event_response(msg_);
  }
...
class Init_TwoInts_GetResult_Event_info
{
public:
  Init_TwoInts_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TwoInts_GetResult_Event_request info(::actionlib::action::TwoInts_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_TwoInts_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::actionlib::action::TwoInts_GetResult_Event>()
{
  return actionlib::action::builder::Init_TwoInts_GetResult_Event_info();
}
