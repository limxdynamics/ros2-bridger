...
{
public:
  explicit Init_GetFloat64_Event_response(::std_srvs::srv::GetFloat64_Event & msg)
  : msg_(msg)
  {}
  ::std_srvs::srv::GetFloat64_Event response(::std_srvs::srv::GetFloat64_Event::_response_type arg)
  {
...
private:
  ::std_srvs::srv::GetFloat64_Event msg_;
};

class Init_GetFloat64_Event_request
{
public:
  explicit Init_GetFloat64_Event_request(::std_srvs::srv::GetFloat64_Event & msg)
  : msg_(msg)
  {}
  Init_GetFloat64_Event_response request(::std_srvs::srv::GetFloat64_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetFloat64_Event_request info(::std_srvs::srv::GetFloat64_Event::_info_type arg)
  {
...
template<>
inline
auto build<::std_srvs::srv::GetFloat64_Event>()
{
  return std_srvs::srv::builder::Init_GetFloat64_Event_info();
}
