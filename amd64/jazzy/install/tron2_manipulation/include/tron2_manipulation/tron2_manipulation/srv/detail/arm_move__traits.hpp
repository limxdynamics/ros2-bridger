...
[[deprecated("use tron2_manipulation::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const tron2_manipulation::srv::arm_move_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  tron2_manipulation::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use tron2_manipulation::srv::to_yaml() instead")]]
inline std::string to_yaml(const tron2_manipulation::srv::arm_move_Event & msg)
{
  return tron2_manipulation::srv::to_yaml(msg);
}

template<>
inline const char * data_type<tron2_manipulation::srv::arm_move_Event>()
{
  return "tron2_manipulation::srv::arm_move_Event";
}

template<>
inline const char * name<tron2_manipulation::srv::arm_move_Event>()
{
  return "tron2_manipulation/srv/arm_move_Event";
}
