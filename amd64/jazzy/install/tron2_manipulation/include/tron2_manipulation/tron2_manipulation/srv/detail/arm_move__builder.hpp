...
{
public:
  explicit Init_arm_move_Event_response(::tron2_manipulation::srv::arm_move_Event & msg)
  : msg_(msg)
  {}
  ::tron2_manipulation::srv::arm_move_Event response(::tron2_manipulation::srv::arm_move_Event::_response_type arg)
  {
...
private:
  ::tron2_manipulation::srv::arm_move_Event msg_;
};

class Init_arm_move_Event_request
{
public:
  explicit Init_arm_move_Event_request(::tron2_manipulation::srv::arm_move_Event & msg)
  : msg_(msg)
  {}
  Init_arm_move_Event_response request(::tron2_manipulation::srv::arm_move_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_arm_move_Event_request info(::tron2_manipulation::srv::arm_move_Event::_info_type arg)
  {
...
template<>
inline
auto build<::tron2_manipulation::srv::arm_move_Event>()
{
  return tron2_manipulation::srv::builder::Init_arm_move_Event_info();
}
