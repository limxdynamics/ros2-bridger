...
#ifndef _WIN32
# define DEPRECATED__upper_body__srv__moveJ_Event __attribute__((deprecated))
#else
# define DEPRECATED__upper_body__srv__moveJ_Event __declspec(deprecated)
#endif
...
struct moveJ_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<upper_body::srv::moveJ_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<upper_body::srv::moveJ_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<upper_body::srv::moveJ_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<upper_body::srv::moveJ_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<upper_body::srv::moveJ_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<upper_body::srv::moveJ_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<upper_body::srv::moveJ_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<upper_body::srv::moveJ_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    upper_body::srv::moveJ_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const upper_body::srv::moveJ_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      upper_body::srv::moveJ_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      upper_body::srv::moveJ_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__upper_body__srv__moveJ_Event
    std::shared_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__upper_body__srv__moveJ_Event
    std::shared_ptr<upper_body::srv::moveJ_Event_<ContainerAllocator> const>
...
// alias to use template instance with default allocator
using moveJ_Event =
  upper_body::srv::moveJ_Event_<std::allocator<void>>;
...
struct moveJ
{
  ...
  using Event = upper_body::srv::moveJ_Event;
};
